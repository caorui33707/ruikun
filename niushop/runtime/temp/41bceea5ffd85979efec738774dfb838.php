...
<script type="text/javascript">
	...
	function setConfigAjax(){
		...
		var terms_of_service = $('#terms_of_service').val();
			...
			$.ajax({
				type:"post",
				url :"<?php echo __URL('PLATFORM_MAIN/config/registerandvisit'); ?>",
				data : {
				...
				success : function(data){
					if(data['code'] > 0)
						{
							showMessage('success', data["message"], "<?php echo __URL('PLATFORM_MAIN/config/registerandvisit'); ?>");
						}else{
