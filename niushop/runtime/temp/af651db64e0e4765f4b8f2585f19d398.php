...
<script>
	...
	function save(){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/config/addorupdatedistributionareaajax'); ?>",
			data : {
			...
			success : function(data){
				if(data['code']>0){
					showMessage("success",data['message'],"<?php echo __URL('PLATFORM_MAIN/config/distributionareamanagement'); ?>");
				}
			} 
		})	
	}
