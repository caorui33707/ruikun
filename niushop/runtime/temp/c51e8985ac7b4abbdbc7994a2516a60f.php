...
<!-- 					src="PLATFORM_IMG/logo1.png" class="m-r-sm"></a> -->
 ...
 <div class="row padder-v">
            <div class="col-sm-9">
              	   <a class="btn btn-sm btn-primary" href="<?php echo __URL('PLATFORM_MAIN/shop/addGuide'); ?>" ><i class="fa fa-plus"></i>&nbsp;添加指南</a>
            </div>
 </div>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/shop/arrivalguide'); ?>",
		async : true,
		data : {
