...
<section class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" id="form" name="form" onsubmit="">
		   <input type="hidden" value="<?php echo $result['id']; ?>" id="article_id"/>
			<div class="form-group">
				<label class="col-sm-2 control-label"><span style="color:red;line-height:30px;">*</span>文章标题</label>
				<div class="col-md-6">
					<input type="text" class="form-control" id="title" value="<?php echo $document_detail['title']; ?>">
				</div>
			</div>
...
<!-- 			<div class="line line-dashed line-lg pull-in"></div> -->
			...
			<div class="form-group" style="display:none;">
                                   ...
                                   <div class="col-sm-4">
                                   	<p><img id="imgLogo" src="__UPLOAD__/<?php echo $result['image']; ?>" class="imglogo"/></p>
					...
					<input type="hidden" id="Logo" value="<?php echo $result['image']; ?>" />
				</span>
...
<!-- 			<div class="line line-dashed line-lg pull-in"></div> -->
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="url" value="<?php echo $result['link_url']; ?>">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<select id="class_id" name="account" class="form-control m-b">
						<?php if(is_array($help_class_list) || $help_class_list instanceof \think\Collection || $help_class_list instanceof \think\Paginator): $i = 0; $__LIST__ = $help_class_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
							<option value="<?php echo $v['class_id']; ?>" <?php if($document_detail['class_id'] == $v['class_id']): ?>selected<?php endif; ?>><?php echo $v['class_name']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?> 
					</select>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<script id="editor" type="text/plain" style="width: 80%; height: 200px;"><?php echo $document_detail['content']; ?></script>
				</div>
			</div>
			<!-- 书签 -->
<!-- 			<div class="line line-dashed line-lg pull-in"></div> -->
				...
				<label class="col-sm-2 control-label">文章内容</label>
				      <div class="col-sm-8">
	                         ...
	                         <div id="editor" class="form-control" style="overflow:scroll;height:150px;max-height:150px"><?php echo $result['content']; ?></div>
	                     </div>
			...
			<div class="form-group">
				...
				<div class="col-md-1">
					<input type="text" class="form-control" id="sort"  value="<?php echo $document_detail['sort']; ?>">
				</div>
			</div>
			<input type="hidden" value="<?php echo $id; ?>" id="document_id" />
<!-- 			<input type="hidden" value="<?php echo $document_detail['content']; ?>" id="content" /> -->
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
  ...
  var ue = UE.getEditor('editor',{
	...
	$(function(){
		...
		function setConfigAjax() {
			...
			$.ajax({
				type : "post",
				url : "<?php echo __URL('PLATFORM_MAIN/config/updatedocument'); ?>",
				data : {
					'id' : id,
					'title' : title,
					'class_id' : class_id,
				...
				success : function(data) {
					if (data["code"] > 0) {
						...
						location.href = "<?php echo __URL('PLATFORM_MAIN/config/helpdocument'); ?>";
					} else {
