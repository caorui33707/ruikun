<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Shop\updatePickupPoint.html";i:1526440417;s:28:"template/adminblue\base.html";i:1513303780;s:45:"template/adminblue\controlCommonVariable.html";i:1513303780;s:32:"template/adminblue\urlModel.html";i:1513303781;s:34:"template/adminblue\pageCommon.html";i:1513303781;s:34:"template/adminblue\openDialog.html";i:1513303780;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="name" type="text" value="<?php echo $pickupPoint_detail['name']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p>
				<select name="province" id="seleAreaNext" onchange="GetProvince();" value="<?php echo $pickupPoint_detail['province_id']; ?>" class="select-common">
					<option value="">请选择省</option>
				</select>
				<select name="city" id="seleAreaThird" onchange="getSelCity();" value="<?php echo $pickupPoint_detail['city_id']; ?>" class="select-common">
					<option value="">请选择市</option>
				</select>
				<select name="district" id="seleAreaFouth" value="<?php echo $pickupPoint_detail['district_id']; ?>" class="select-common">
	...
	<dl>
		...
		<dd>
			<p><input id="address" type="text" value="<?php echo $pickupPoint_detail['address']; ?>" class="input-common"></p>
	...
	<dl>
		<dt>自提点联系人:</dt>
		<dd>
			<p><input id="contact" type="text" value="<?php echo $pickupPoint_detail['contact']; ?>" class="input-common"></p>
		</dd>
	</dl>
	<dl>
		<dt><span style="color:red;">*</span>&nbsp;&nbsp;自提点电话:</dt>
		<dd>
			<p><input id="phone" type="text" value="<?php echo $pickupPoint_detail['phone']; ?>" class="input-common"></p>
...
// 		}
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/shop/updatepickuppoint'); ?>",
		data : {
			'id' :id,
			'name' : name,
			'address' : address,
