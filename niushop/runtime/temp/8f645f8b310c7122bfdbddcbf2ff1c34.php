<?php if (!defined('THINK_PATH')) exit(); /*a:14:{s:50:"template/shop\blue\Member\goodsEvaluationList.html";i:1513303781;s:28:"template/shop\blue\base.html";i:1513303781;s:32:"template/shop\blue\urlModel.html";i:1513303782;s:34:"template/shop\blue\controlTop.html";i:1513303781;s:41:"template/shop\blue\controlHeadSerach.html";i:1513303781;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1513303781;s:43:"template/shop\blue\controlHeadGoodType.html";i:1513303781;s:40:"template/shop\blue\controlCommonNav.html";i:1513303781;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1526717051;s:41:"template/shop\blue\controlCommonPage.html";i:1513303781;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1513303781;s:37:"template/shop\blue\controlBottom.html";i:1513303781;s:36:"template/shop\blue\controlLogin.html";i:1513303781;s:37:"template/shop\blue\baidu_js_push.html";i:1513303781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<article class="list">
		...
		<div class="item">
			...
			<ul>
				...
				<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/shopcollectionlist'); ?>';" data-href="<?php echo __URL('SHOP_MAIN/member/shopcollectionlist'); ?>">
					<span>店铺收藏</span>
					<i class="icon i-arrow"></i>
				</li>
			</ul>
		...
		<div class="item">
			...
			<ul>
				<!--<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/useragent'); ?>';" data-href="<?php echo __URL('SHOP_MAIN/member/useragent'); ?>">-->
					<!--<span>代理申请</span>-->
					<!--<i class="icon i-arrow"></i>-->
				<!--</li>-->
				<li onclick="location.href='<?php echo __URL('SHOP_MAIN/member/agentList'); ?>';" data-href="<?php echo __URL('SHOP_MAIN/member/agentList'); ?>">
					<span>代理申请列表</span>
					<i class="icon i-arrow"></i>
				</li>
			</ul>
...
$(function(){
	...
	<div class="member-main">
		<div class="box">
			<div class="tabmenu">
				<ul class="tab">
					<li class="active"><?php echo lang('commodity_evaluation_drying_list'); ?></li>
				</ul>
			</div>
			<div class="blank"></div>
			<table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#eeeeee" class="item_list">
				<tr>
					<th width="20%"></th>
					<th width="30%"><?php echo lang('goods_commodity_information'); ?></th>
					<th width="50%"><?php echo lang('member_evaluate'); ?></th>
<!-- 					<th width="20%">晒单</th> -->
				</tr>
				<tbody id="list_content">
					<?php if(count($goodsEvaluationList) == 0): ?>
					<tr>
						<td colspan="5" align="center"><?php echo lang('member_no_single_sun'); ?></td>
					</tr>
					<?php else: if(is_array($goodsEvaluationList) || $goodsEvaluationList instanceof \think\Collection || $goodsEvaluationList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsEvaluationList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
					<tr>
						<td colspan="4"><?php echo lang('member_evaluation_time'); ?>：<?php echo getTimeStampTurnTime($item['addtime'] ); ?></td>
					</tr>
					<tr>
						<td>
							<div style="display: inline-block;">
								<a target="_blank" href="<?php echo __URL('SHOP_MAIN/goods/goodsInfo','goodsid='.$item['goods_id']); ?>">
									<img src="<?php echo __IMG($item['goods_image']); ?>" style="max-height: 60px">
								</a>
							</div>
						</td>
						<td>
							<div style="display: inline-block;">
								<a target="_blank" href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$item['goods_id']); ?>"><?php echo $item['goods_name']; ?></a>
							</div>
						</td>
						<td width="400">
							<div>
								<span><?php echo lang('member_score'); ?>：</span>
								<?php $__FOR_START_21602__=0;$__FOR_END_21602__=5;for($i=$__FOR_START_21602__;$i < $__FOR_END_21602__;$i+=1){ if($item['scores'] > $i): ?>
									<img src="__TEMP__/<?php echo $style; ?>/public/images/star-on.png" style="width: 16px;">
									<?php else: ?>
									<img src="__TEMP__/<?php echo $style; ?>/public/images/star-off.png" style="width: 16px;">
									<?php endif; } ?>
							</div><br>
							<div><?php echo lang('goods_commodity_evaluation'); ?>：<?php echo $item['content']; ?></div>
							<?php if(!(empty($item['evaluationImg']) || (($item['evaluationImg'] instanceof \think\Collection || $item['evaluationImg'] instanceof \think\Paginator ) && $item['evaluationImg']->isEmpty()))): ?>
								<div style="display: inline-block;width: 50px;"></div>
								
								<?php if(is_array($item['evaluationImg']) || $item['evaluationImg'] instanceof \think\Collection || $item['evaluationImg'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['evaluationImg'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<img src="<?php echo __IMG($vo); ?>" alt="" style="max-height: 60px;margin: 10px 10px 10px 0; ">
								<?php endforeach; endif; else: echo "" ;endif; endif; if($item['explain_first'] != ''): ?> <br>
							<div>[<?php echo lang('goods_shopkeeper_replies'); ?>]：<?php echo $item['explain_first']; ?></div>
							<?php endif; if($item['again_content'] != ''): ?> <br>
							<div><?php echo lang('goods_additional_evaluation'); ?>：<?php echo $item['again_content']; ?></div>
							<?php endif; if(!(empty($item['againEvaluationImg']) || (($item['againEvaluationImg'] instanceof \think\Collection || $item['againEvaluationImg'] instanceof \think\Paginator ) && $item['againEvaluationImg']->isEmpty()))): ?>
								<div style="display: inline-block;width: 50px;"></div>
								<?php if(is_array($item['againEvaluationImg']) || $item['againEvaluationImg'] instanceof \think\Collection || $item['againEvaluationImg'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['againEvaluationImg'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<img src="<?php echo __IMG($vo); ?>" alt="" style="max-height: 6px;margin: 10px 10px 10px 0; ">
								<?php endforeach; endif; else: echo "" ;endif; endif; if($item['again_explain'] != ''): ?> <br>
							<div>[<?php echo lang('goods_shopkeeper_replies'); ?>]：<?php echo $item['again_explain']; ?></div>
							<?php endif; ?>
						</td>
<!-- 						<td width="80"></td> -->
					</tr>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_26413__=1;$__FOR_END_26413__=$page_count+1;for($i=$__FOR_START_26413__;$i < $__FOR_END_26413__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_10820__=1;$__FOR_END_10820__=$page_num+1;for($i=$__FOR_START_10820__;$i < $__FOR_END_10820__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_16215__=$page_count-$page_num+1;$__FOR_END_16215__=$page_count+1;for($i=$__FOR_START_16215__;$i < $__FOR_END_16215__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_214__=$page-($page_num-1)/2;$__FOR_END_214__=$page+($page_num-1)/2+1;for($i=$__FOR_START_214__;$i < $__FOR_END_214__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
