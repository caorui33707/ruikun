<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"template/shop\default\Login\register.html";i:1525837917;s:45:"template/shop\default\Login\registerBase.html";i:1513303782;s:35:"template/shop\default\urlModel.html";i:1513303782;s:38:"template/shop\default\loginTopNav.html";i:1525838227;}*/ ?>
<!DOCTYPE html>
...
$(document).ready(function(){
	...
	$("#btn_submit").click(function(){
		...
		if(!(username.length ==11)){
			...
			$('#mobileregistermodel-username').css("border","1px solid red");
			$("#usernameyz").css("color","red").text("请输入11位手机号");
			return false;
		}else{
...
function verifyUsername(username){
    ...
    if(!/^1(3|4|5|6|7|8)\d{9}$/.test(username) ){
        is_true = 1;
        $("#mobileregistermodel-username").trigger("focus");
        $('#mobileregistermodel-username').css("border","1px solid red");
        $("#usernameyz").css("color","red").text("手机号格式错误");
        return is_true;
    }
					...
					<div class="reg-wrap-con" style="background: url(__TEMP__/<?php echo $style; ?>/public/images/register_bg_image.png) no-repeat right 70px;">
						<form id="EmailRegisterModel" class="form-horizontal" name="EmailRegisterModel" action="<?php echo __URL('SHOP_MAIN/login/register'); ?>" method="post">
							...
							<div class="form-group form-group-spe">
								...
								<div class="form-control-box">
									<input type="text" id="mobileregistermodel-username" class="form-control" name="mobile" placeholder="请输入用户名，必须在3到16个字符范围内" />
									<span id="usernameyz"></span>
									<input type="hidden" value="不存在" id="isset_username"/>
								</div>
								<div class="invalid"></div>
