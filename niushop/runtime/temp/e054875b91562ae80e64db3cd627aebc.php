	...
	<div class="panel-body">
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-2">
					<input name="UserCode" id="reg_member_self_point" class="form-control" type="number" min="0"  value="<?php echo $res['reg_member_self_point']; ?>"  onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-1" style="width:auto;">
					<label class="switch">
                         <input id="register_open" type="checkbox" onchange="setIntegralAjax();"  class="checkbox" <?php if($integralConfig['register_integral'] == 1): ?>checked="checked"<?php endif; ?>>
                         <span></span> 
                    </label>
				</div>
           ...
           <div class="form-group">
				...
				<div class="col-md-2">
					<input name="UserCode" id="sign_point" type="number" class="form-control" value="<?php echo $res['sign_point']; ?>"  min="0" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')"  >
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-md-1" style="width:auto;">
					<label class="switch">
                         <input id="sign_open" type="checkbox" onchange="setIntegralAjax();" class="checkbox" <?php if($integralConfig['sign_integral'] == 1): ?>checked="checked"<?php endif; ?>>
                         <span></span> 
                    </label>
				</div>
           ...
           <div class="form-group">
				...
				<div class="col-md-2">
					<input name="UserCode" id="share_point" type="number"  class="form-control" value="<?php echo $res['share_point']; ?>" min="0"  onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" >
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-md-1" style="width:auto;">
					<label class="switch">
                        <input id="share_open" type="checkbox" onchange="setIntegralAjax();" class="checkbox" <?php if($integralConfig['share_integral'] == 1): ?>checked="checked"<?php endif; ?>>
                         <span></span> 
                    </label>
				</div>
           ...
           <div class="form-group">
				...
				<div class="col-md-2">
					<input id="click_point" type="number" value="<?php echo $res['click_point']; ?>" min="0"  onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" class="form-control" >
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
           <div class="form-group">
				...
				<div class="col-md-2">
					<input id="comment_point" type="number" value="<?php echo $res['comment_point']; ?>" min="0"  onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" class="form-control" >
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
...
function setIntegralAjax(){
	...
	$.ajax({
		type : 'post',
		url : "<?php echo __URL('PLATFORM_MAIN/promotion/setintegralajax'); ?>",
		data : {
			'register':register,
			'sign':sign,
			'share':share
...
function setRewardRuleAjax(){
	...
	$.ajax({
		type : 'post',
		url : "<?php echo __URL('PLATFORM_MAIN/config/integral'); ?>",
		data : {
		...
		success : function(data){
			if(data['code'] >=0){
				showMessage("success", "设置成功！", "<?php echo __URL('PLATFORM_MAIN/promotion/integral'); ?>");
			}else{
