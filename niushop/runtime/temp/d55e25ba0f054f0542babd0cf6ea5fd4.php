           ...
           <div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<input type="text" class="form-control" id="companyname" value="<?php echo $info['copyright_companyname']; ?>" style="width:30%;">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<input type="text" class="form-control" id="link"  value="<?php echo $info['copyright_link']; ?>" style="width:30%;">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
                ...
                <div class="col-sm-4">
                <textarea name="store_zy" rows="2" id="third_count" class="textarea w400" style="width:350px;height:100px;"><?php echo $info['copyright_desc']; ?></textarea>
                    <!-- <div id="desc" class="form-control" style="overflow:scroll;height:150px;max-height:150px"><?php echo $info['copyright_desc']; ?></div> -->
                </div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
