	...
	<div class="box">
		...
		<div class="ncm-user-profile">
					...
					<table cellpadding="10" width="600px">
						<tr>
							...
							<td width="65%" align="left">
								<?php if($member_img != '' and $member_img != '0'): ?>
								<img src="<?php echo __IMG($member_img); ?>" width="120px" height="120px" onClick="setTabCatGoods('tab',2,3)"/>
								<?php else: ?>
						...
						<tr>
							...
							<td align="left">
								<label><input type="radio" name="sex" value="0" checked="checked" id="baomi"/><?php echo lang('member_secrecy'); ?> </label>&nbsp;
								<label><input type="radio" name="sex" value="1" id="nan" /><?php echo lang('member_man'); ?></label>&nbsp;&nbsp;
								<label><input type="radio" name="sex" value="2" id="nv"/><?php echo lang('member_woman'); ?> </label>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" align="center">
								<label class="submit-border">
									...
									<input name="submit" type="submit" class="main-btn main-btn-large" value="<?php echo lang('member_confirm_change'); ?>"  id="btn_submit"/>
								</label>
							</td>
						</tr>
						<tr>
			...
			<div class="ncm-default-form"  id="con_tab_2" style="display:none; color:red">
				<form name="formEdit2" action="<?php echo __URL('SHOP_MAIN/member/person'); ?>" method="post" enctype="multipart/form-data" >
					<table cellpadding="10">
						<tr>
							<td width="35%" align="right"><?php echo lang('member_avatar_preview'); ?>：</td>
							<td class="user-avatar">
								<div class="hint"><?php echo lang('member_improve_personal_information'); ?>。<br /><span><?php echo lang('member_best_default_size'); ?>。</span></div>
							</td>
						</tr>
						<tr>
							<td colspan="2" align="center">
						...
						<tr>
							<td colspan="2" align="center">
								<label class="submit-border">
									...
									<input name="submit2" type="submit" class="main-btn main-btn-large" value="<?php echo lang('member_confirm_change'); ?>"  />
								</label>
							</td>
						</tr>
					</table>
...
$(document).ready(function(){
	...
	sexsex = "<?php echo $member_info['user_info']['sex']; ?>";
	if(sexsex == 1){
