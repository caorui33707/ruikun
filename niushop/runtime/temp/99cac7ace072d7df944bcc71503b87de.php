									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<label class="switch" style="float:left;margin-right:10px;">
												<input type="checkbox" id="recommend_mobile" <?php if($recommend_mobile['is_use']=='1'): ?>checked="checked" value="1" <?php else: ?> value="0"  <?php endif; ?> >
												<span></span>
											</label>
...
<script>
	...
	$('#recommend_mobile').change(function(){
	   ...
	   // var recommend_mobile = $('#').val();
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo __URL('PLATFORM_MAIN/config/recommendMobile'); ?>",
            data: {"is_use":is_use},
