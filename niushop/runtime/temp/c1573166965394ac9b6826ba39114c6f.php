<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:50:"template/shop\blue\Member\updateMemberAddress.html";i:1513303781;s:28:"template/shop\blue\base.html";i:1513303781;s:32:"template/shop\blue\urlModel.html";i:1513303782;s:34:"template/shop\blue\controlTop.html";i:1513303781;s:41:"template/shop\blue\controlHeadSerach.html";i:1513303781;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1513303781;s:43:"template/shop\blue\controlHeadGoodType.html";i:1513303781;s:40:"template/shop\blue\controlCommonNav.html";i:1513303781;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1526712873;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1513303781;s:37:"template/shop\blue\controlBottom.html";i:1513303781;s:36:"template/shop\blue\controlLogin.html";i:1513303781;s:37:"template/shop\blue\baidu_js_push.html";i:1513303781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
$(function(){
	...
	<div class="member-main">
		<div class="box">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="first active"><?php echo lang('member_modify_delivery_address'); ?></li>
				</ul>
			</div>
			...
			<div class="mar_top">
				<table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#eeeeee">
					<tr>
						...
						(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right" width="10%"><?php echo lang('member_consignee_name'); ?>：</td>
						<td align="left" width="40%"><input name="consignee" type="text" class="inputBg" id="Name" value="<?php echo $address_info['consigner']; ?>" />(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right"><?php echo lang('member_detailed_address'); ?>：</td>
						<td align="left" colspan="3"><input name="address" type="text" class="inputBg" id="AddressInfo" value="<?php echo $address_info['address']; ?>" style="width: 692px;"/>(<?php echo lang('member_required'); ?>)</td>
					</tr>
					<tr>
						<td align="right"><?php echo lang('member_phone'); ?>：</td>
						<td align="left"><input name="mobile" type="text" class="inputBg" id="Moblie" value="<?php echo $address_info['mobile']; ?>" />(<?php echo lang('member_required'); ?>)</td>
					</tr> 
					<tr>
						<td colspan="4" align="center">
						<button onclick="saveAddress()" class="common-btn"><?php echo lang('member_confirm_change'); ?></button>
						</td>
					</tr>
				</table>
...
$(function(){
	...
	$(".js-bread-crumb").attr("href",'<?php echo __URL('SHOP_MAIN/member/addresslist'); ?>');
	$(".js-bread-crumb").text("<?php echo lang('member_delivery_address'); ?>");
	$(".js-bread-crumb").parent().append('<span class="crumbs-arrow">&gt;</span><a href="<?php echo __URL('SHOP_MAIN/member/updatememberaddress','id='.$address_info['id']); ?>"><?php echo lang('member_modify_delivery_address'); ?></a>');
	...
	selProvince.options.add(opt);
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('SHOP_MAIN/member/getprovince'); ?>",
			dataType : "json",
			success : function(data) {
	...
	if(address_id!=0){
		...
		//加载市
				...
				$.ajax({
					type: "post",
					url: "<?php echo __URL('SHOP_MAIN/member/getcity'); ?>",
					dataType: "json",
			...
			var selArea = $("#seleAreaFouth")[0];
				...
				var opt = new Option("<?php echo lang('goods_select_district_or_county'); ?>", "-1");
				selArea.options.add(opt);
				$.ajax({
					type: "post",
					url: "<?php echo __URL('SHOP_MAIN/member/getdistrict'); ?>",
					dataType: "json",
					data: { "city_id": city },
					success: function (data) {
						if (data != null && data.length > 0) {
