<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\Shop\offlineStore.html";i:1513303781;s:28:"template/adminblue\base.html";i:1513303780;s:45:"template/adminblue\controlCommonVariable.html";i:1513303780;s:32:"template/adminblue\urlModel.html";i:1513303781;s:34:"template/adminblue\pageCommon.html";i:1513303781;s:34:"template/adminblue\openDialog.html";i:1513303780;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style"  style="margin-bottom: 150px;">
	<dl>
		<dt>兑换码生成前缀:</dt>
		<dd>
	...
	<dl>
		<dt></dt>
		<dd>
		<button class="edit_button btn-common btn-big" onclick="save();">提交</button>
		</dd>
	</dl>
</div>
...
<script src="http://webapi.amap.com/maps?v=1.3&amp;key=2df5711d4e2fd9ecd1622b5a53fc6b1d&callback=init"></script>
		...
		<script type="text/javascript">
		    var address = '<?php echo $shop_info['latitude_longitude']; ?>';
		    if(address == ''){
		    	var address = [116.39,39.9];
		    }else{
		    	var address = [<?php echo $shop_info['latitude_longitude']; ?>];
		    }
