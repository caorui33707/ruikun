...
<div class="user-right">
	...
	<div class="tabmenu">
		<ul class="tab pngFix">
			<li class="first active" style="border:1px #E31939 solid;background:#E31939;padding:6px 6px;"><a href="<?php echo __URL('SHOP_MAIN/member/addressinsert'); ?>" style="font-size: 14px;"><?php echo lang('member_new_delivery_address'); ?></a></li>
		</ul>
	</div>
 <?php if($total_count != ''): ?>
	<div>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_28146__=1;$__FOR_END_28146__=$page_count+1;for($i=$__FOR_START_28146__;$i < $__FOR_END_28146__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_11517__=1;$__FOR_END_11517__=$page_num+1;for($i=$__FOR_START_11517__;$i < $__FOR_END_11517__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_9556__=$page_count-$page_num+1;$__FOR_END_9556__=$page_count+1;for($i=$__FOR_START_9556__;$i < $__FOR_END_9556__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_31911__=$page-($page_num-1)/2;$__FOR_END_31911__=$page+($page_num-1)/2+1;for($i=$__FOR_START_31911__;$i < $__FOR_END_31911__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
