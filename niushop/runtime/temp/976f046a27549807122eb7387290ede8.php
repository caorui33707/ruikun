<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Goods\addGoodsSpec.html";i:1513303780;s:28:"template/adminblue\base.html";i:1513303780;s:45:"template/adminblue\controlCommonVariable.html";i:1513303780;s:32:"template/adminblue\urlModel.html";i:1513303781;s:34:"template/adminblue\pageCommon.html";i:1513303781;s:34:"template/adminblue\openDialog.html";i:1513303780;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<input id="sort" type="text" value="0" onkeyup='this.value=this.value.replace(/\D/gi,"")' class="input-common"/>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<select id="attributeSelect">
				<option value="0">请选择商品类型</option>
					<?php if(is_array($attribute_list) || $attribute_list instanceof \think\Collection || $attribute_list instanceof \think\Paginator): if( count($attribute_list)==0 ) : echo "" ;else: foreach($attribute_list as $key=>$sup): ?>
						<option value="<?php echo $sup['attr_id']; ?>"><?php echo $sup['attr_name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
		</dd>
	</dl>
