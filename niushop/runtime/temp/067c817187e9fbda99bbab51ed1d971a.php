<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:56:"template/platform\Member\userCommissionWithdrawList.html";i:1513303781;s:27:"template/platform\base.html";i:1526449216;s:44:"template/platform\controlCommonVariable.html";i:1513303781;s:31:"template/platform\urlModel.html";i:1513303781;s:27:"template/platform\page.html";i:1513303781;s:33:"template/platform\openDialog.html";i:1513303781;}*/ ?>
<!DOCTYPE html>
...
$(function(){
	...
	function audit(id,status){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/member/usercommissionwithdrawaudit'); ?>",
			async : true,
			data : {
				"id" : id,
				"status":status
			...
			success : function(data) {
				if (data["code"] > 0) {
					showMessage('success', data["message"],"<?php echo __URL('PLATFORM_MAIN/member/usercommissionwithdrawlist'); ?>");
				}else{
   ...
   function refusetrue(){
	   ...
	   $.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/member/usercommissionwithdrawrefuse'); ?>",
			async : true,
			data : {
				"id" : uid,
				"status":status,
	...
	function details(id){
		   $.ajax({
				type : "post",
				url : "<?php echo __URL('PLATFORM_MAIN/member/getwithdrawalsinfo'); ?>",
				async : true,
				data : {
					"id" :id
				},
