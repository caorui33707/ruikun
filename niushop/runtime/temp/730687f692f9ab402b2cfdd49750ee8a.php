...
<header class="header clearfix">
	<div class="row m-t-sm">
		<a href="<?php echo __URL('PLATFORM_MAIN/Wchat/qrcode'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> 添加自定义模板</a>
	</div>
</header>
