<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"template/shop\default\Login\mobile.html";i:1526348517;s:45:"template/shop\default\Login\registerBase.html";i:1513303782;s:35:"template/shop\default\urlModel.html";i:1513303782;s:38:"template/shop\default\loginTopNav.html";i:1525847282;}*/ ?>
<!DOCTYPE html>
...
$(document).ready(function(){
	$("#mobile").keyup(function(){
		...
		if(isset_mobile == "true"){
			$('#mobile').css("border","1px solid red");
			$("#mobileyz").css("color","red").text("<?php echo lang('phone_has_been_registered'); ?>");
			$("#mobile").trigger("focus");
			return false;
		}else{
			$('#mobile').css("border","1px solid #ccc");
	...
	$("#repass").keyup(function(){
		...
		if( !(repass == password)){
			...
			$("#qrrepass").css("color","red").text("<?php echo lang('two_input_is_inconsistent'); ?>");
			$("#password").css("border","1px solid #ccc");
			$("#yzpassword").css("color","red").text("");
			return false;
		}else{
	...
	$("#btn_submit").click(function(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('SHOP_MAIN/login/register_check_code'); ?>",
	...
	$("#mobile").change(function(){
		if(!($(this).val().search(/^1(3|4|5|7|8)\d{9}$/)==-1)){
			...
			$.ajax({
				type: "GET",
				url: "<?php echo __URL('SHOP_MAIN/login/mobile'); ?>",
		...
		$.ajax({
			...
			success: function(data){
				if(data){
					...
					$.ajax({
						type: "POST",
						url: "<?php echo __URL('SHOP_MAIN/login/sendsmsregistercode'); ?>",
		...
		<?php endif; ?>
				...
				<div class="reg-wrap">
					<div class="reg-wrap-con" style="background: url(__TEMP__/<?php echo $style; ?>/public/images/register_bg_image.png) no-repeat right 70px;">
						<!-- 手机注册 start -->
						<form id="MobileRegisterModel" class="form-horizontal" name="MobileRegisterModel" action="<?php echo __URL('SHOP_MAIN/login/mobile'); ?>" method="post">
							...
							<input style="display: none">
								...
								<div class="form-group form-group-spe">
									...
									<div class="form-control-box" style="width: 450px;">
										...
										<label class="img" style="margin-left: 5px"> <img class="verifyimg" src="<?php echo __URL('SHOP_MAIN/captcha'); ?>" onclick="this.src='<?php echo __URL('SHOP_MAIN/captcha?tag=1'); ?>'+'&send='+Math.random()"  alt="captcha" style="vertical-align: middle; cursor: pointer; height: 35px;" /> </label>
								...
								<?php endif; if($notice['recommendMobile'] == 1): ?>
									<!-- 推荐人手机号码 -->
									<!--<div class="form-group form-group-spe">-->
										<!--<label for="recommend_mobile" class="input-left">-->
											<!--&lt;!&ndash;<span class="spark">*</span>&ndash;&gt;-->
											<!--<span >推荐人手机号：</span>-->
										<!--</label>-->
										<!--<div class="form-control-box">-->
											<!--<input type="text" id="recommend_mobile" class="form-control" name="recommend_mobile" placeholder="请输入您的手机号" />-->
                                            <!--<input type="button" class="phonecode" id="recommendCode" name="recommend_code_mobile" value="获取短信校验码">-->
											<!--&lt;!&ndash; <span class='state1'>请输入手机号</span> &ndash;&gt;-->
											<!--<span id="recommend_mobile_yz"></span>-->
										<!--</div>-->
										<!--<div class="invalid"></div>-->
									<!--</div>-->
									<!--<input style="display: none">-->
								...
								<div class="form-group form-group-spe">
									...
									<div class="form-control-box">
										<input type="text" id="mobileregistermodel-invite_code" class="input-small" name="invite_code">
									</div>
									<div class="invalid"></div>
								</div>
                            <?php endif; ?>
								...
								<div class="form-group m-10">
									...
									<div class="form-control-box">
										<label for="remember1">
											...
											<span>
												我已阅读并同意
												<a href="<?php echo __URL('SHOP_MAIN/helpcenter/index','id=17&class_id=6'); ?>" class="user_protocol"  target="_blank">《用户注册协议》</a>
											</span>
											&nbsp;&nbsp;&nbsp;&nbsp;
