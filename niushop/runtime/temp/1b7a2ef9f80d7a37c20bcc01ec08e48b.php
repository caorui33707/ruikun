	           ...
	           <div class="line line-dashed line-lg pull-in"></div>
				...
				<div class="form-group">
					...
					<div class="col-md-4" style="width:80%;">
						<input id="Accesskey" type="text"  value="<?php echo $config_data['data']['qiniu']['Accesskey']; ?>" class="form-control" style="width:30%;">
				...
				<div class="form-group">
					...
					<div class="col-md-4" style="width:80%;">
						<input type="text" class="form-control" id="Secretkey" value="<?php echo $config_data['data']['qiniu']['Secretkey']; ?>" style="width:30%;">
				...
				<div class="form-group">
					...
					<div class="col-md-4" style="width:80%;">
						<input type="text" class="form-control" id="Bucket" value="<?php echo $config_data['data']['qiniu']['Bucket']; ?>" style="width:30%;">						
				...
				<div class="form-group">
					...
					<div class="col-md-4" style="width:80%;">
						<input type="text" class="form-control" id="QiniuUrl" value="<?php echo $config_data['data']['qiniu']['QiniuUrl']; ?>" style="width:30%;">
...
function setUploadConfig(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('PLATFORM_MAIN/config/copyrightinfo'); ?>",
		async : true,
		data : {
			"type" : upload_type
		},
		success : function(data){
			if(data['code'] > 0)
				{
					showMessage('success', data["message"], "<?php echo __URL('PLATFORM_MAIN/config/uploadtype'); ?>");
...
function setQiniuConfigAjax(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('PLATFORM_MAIN/config/setQiniuconfig'); ?>",
		async : true,
		data : {
			"Accesskey" : Accesskey,
			'Secretkey' : Secretkey,
...
function selectConfig(){
	...
	if(flag){
		$.ajax({
			type:"post",
			url : "<?php echo __URL('PLATFORM_MAIN/config/setuploadtype'); ?>",
			async : true,
			data : {
				"type" : type
			},
