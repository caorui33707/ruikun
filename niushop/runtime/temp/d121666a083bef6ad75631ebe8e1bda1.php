...
<section class="panel panel-default">
	<header class="panel-heading font-bold"> 添加代理商 </header>
	<div class="panel-body">
		<form class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-2 control-label"><span style="color:red;margin-right:10px;">*</span>代理商名称</label>
				<div class="col-md-4">
					<input type="text" class="form-control" id="agent_name" value="">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="linkman_name" value="">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="linkman_tel" value="">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="linkman_address" value="">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="identity_card" value="">
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-4">
					<textarea id="desc" name="desc" style="height: 300px; width: 500px; "></textarea>
				</div>
			</div>
			...
			<div id="company_stye" style="display: none">
			...
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					<a href="javascript:void(0);" onclick="addAgantAjax()" class="btn btn-primary">保存</a>
				</div>
			</div>
		</form>
	</div>
...
//  		verify(ad_image, link_url);
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/config/addShopAgant'); ?>",
			data : data,
			async : true,
