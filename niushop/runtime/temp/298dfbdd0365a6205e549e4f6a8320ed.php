<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:56:"template/adminblue\Account\applyShopAccountWithdraw.html";i:1513303780;s:28:"template/adminblue\base.html";i:1513303780;s:45:"template/adminblue\controlCommonVariable.html";i:1513303780;s:32:"template/adminblue\urlModel.html";i:1513303781;s:34:"template/adminblue\pageCommon.html";i:1513303781;s:34:"template/adminblue\openDialog.html";i:1513303780;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			...
			<p class="hint"><span style="color:orange;">可提现金额为<?php echo $shop_account_info['shop_balance']; ?>。</span></p>
	...
	<dl>
		...
		<dd>
			<p>
				...
				<?php if(is_array($bank_lsit) || $bank_lsit instanceof \think\Collection || $bank_lsit instanceof \think\Paginator): if( count($bank_lsit)==0 ) : echo "" ;else: foreach($bank_lsit as $key=>$bank_info): if($bank_info['is_default'] == 1): ?>
						<li class="border-check" data-check=1 data-id=<?php echo $bank_info['id']; ?> onclick="check_this(this);">
							<p><?php echo $bank_info["branch_bank_name"]; ?></p>
							<p><?php echo $bank_info["account_number"]; ?></p>
							<p><?php echo $bank_info["realname"]; ?></p>
							<p><?php echo $bank_info["mobile"]; ?></p>
							<img src="ADMIN_IMG/qrcode/check_qrcode1.png" class="qrcode_img"style="position:absolute;bottom:-1px;height:30px;right:-1px;"/>
						</li>					
					<?php else: ?> 
						<li data-check=0 data-id=<?php echo $bank_info['id']; ?> onclick="check_this(this);">
							<p><?php echo $bank_info["branch_bank_name"]; ?></p>
							<p><?php echo $bank_info["account_number"]; ?></p>
							<p><?php echo $bank_info["realname"]; ?></p>
							<p><?php echo $bank_info["mobile"]; ?></p>
...
<script>		
	function applyShopAccountWithdraw(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('ADMIN_MAIN/account/applyshopaccountwithdraw'); ?>",
			data:{
				'cash':cash,
			...
			success:function (data) {
				if (data["code"] > 0) {
					showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/account/shopaccountwithdrawlist'); ?>");
				}else{
