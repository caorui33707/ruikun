			...
			<form action="" method="post" name="theForm">
				...
				<table width="100%" border="0" cellpadding="10" cellspacing="1"  style="background:  #fff">
					...
					<tr>
						...
						<td align="left" width="40%"><input name="agent_name" type="text" class="inputBg" id="agent_name" />(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right" width="10%">联系人姓名：</td>
						<td align="left" width="40%"><input name="linkman_name" type="text" class="inputBg" id="linkman_name" />(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right">联系人电话：</td>
						<td align="left"><input name="linkman_tel" type="text" class="inputBg" id="linkman_tel" />(<?php echo lang('member_required'); ?>)</td>
					</tr>
					...
					<tr>
						...
						<td align="left" width="40%"><input name="linkman_address" type="text" class="inputBg" id="linkman_address" />(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right">身份证：</td>
						<td align="left"><input name="identity_card" type="text" class="inputBg" id="identity_card" />(<?php echo lang('member_required'); ?>)</td>
					</tr>

					<tr >
						<td align="right" >上传身份证证件图</td>
						<td class="col-md-4">
							<p><img id="imgLogo" width="120px"  height="260px"  src="<?php echo $data['business_license']; ?>" class="imglogo"/></p>
							<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		...
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
														...
														<input type="hidden" id="Logo" value="<?php echo $data['business_license']; ?>" />
													</span>
				...
				<tbody id="company_stye"  style="display: none"  > <!-- <?php if($data['agent_type'] == 1): ?> style="display: none" <?php endif; ?> -->
					...
					<tr>
						...
						<td align="left">
							<input type="text" class="inputBg"   id="company_name" value="<?php echo $data['company_name']; ?>">
						</td>
					</tr>
					...
					<tr>
						...
						<td align="left">
							<input type="text" class="inputBg" id="business_licence_number" value="<?php echo $data['business_licence_number']; ?>">
						</td>
					</tr>
					...
					<tr >
						...
						<td class="col-md-4">
							<p><img id="business_license" width="120px"  height="260px"  src="<?php echo $data['business_license']; ?>" class="imglogo"/></p>
							<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
														<span style="width: 97px;height: 34px;position: absolute;left: 0;top: 0;z-index: 2;cursor: pointer;">
														<input hidefocus="true" size="1" class="input-file" name="file_upload"
															...
															<input type="hidden" id="logo_business_license" value="<?php echo $data['business_license']; ?>" />
														</span>
								<a class="btn btn-default"><i class="fa fa-cloud-upload text"></i><span class="text">上传图片</span></a>
							</a>
						</td>
					...
					<tr align="right">
						...
						<td align="left">
							<input type="text" class="inputBg" id="organization_code" value="<?php echo $data['organization_code']; ?>">
						</td>
					</tr>
