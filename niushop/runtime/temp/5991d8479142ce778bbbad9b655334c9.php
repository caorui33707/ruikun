<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:51:"template/adminblue\Account\shopBankAccountList.html";i:1513303780;s:28:"template/adminblue\base.html";i:1513303780;s:45:"template/adminblue\controlCommonVariable.html";i:1513303780;s:32:"template/adminblue\urlModel.html";i:1513303781;s:34:"template/adminblue\pageCommon.html";i:1513303781;s:34:"template/adminblue\openDialog.html";i:1513303780;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<th style="text-align: left;"><button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/Account/addShopAccountBank'); ?>';" style="margin:0 !important;">添加提现账户</button></th>
...
//查询用户列表
	function LoadingInfo(pageIndex) {
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/Account/shopBankAccountList'); ?>",
			async : true,
			data : {
	...
	function Delete_bank(id){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/account/deleteshopbankaccouht'); ?>",
			async : true,
			data : {
				"id" : id,
			},
			success : function(data) {
				if(data["code"] > 0 ){
					...
					location.href="<?php echo __URL('ADMIN_MAIN/account/shopbankaccountlist'); ?>";
				}else{
