					...
					<tr>
					     ...
					     <td style="text-align: center;line-height:59px;">
					     	<?php if($pay_obj['key'] == 'WPAY'): ?>
					  			<a href="<?php echo __URL('PLATFORM_MAIN/config/payconfig?type=wchat#wpay'); ?>">配置</a>
					  		<?php else: ?>
					  			<a href="<?php echo __URL('PLATFORM_MAIN/config/payaliconfig'); ?>">配置</a>
							<?php endif; ?>					  		  
					  	</td>
					</tr>
				<?php endforeach; endif; else: echo "" ;endif; ?>
...
function set_status(type,event){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/config/setstatus'); ?>",
		data : {
