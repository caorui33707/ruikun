<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:42:"template/platform\Config\notifyConfig.html";i:1513303781;s:27:"template/platform\base.html";i:1526464627;s:44:"template/platform\controlCommonVariable.html";i:1513303781;s:31:"template/platform\urlModel.html";i:1513303781;s:33:"template/platform\openDialog.html";i:1513303781;}*/ ?>
<!DOCTYPE html>
					...
					<tr style="border:1px solid #e5e5e5;border-top:0;background:none;">
					     ...
					     <td style="text-align: center;background:none;">
							...
							<?php endif; if($notify_obj['key'] == 'EMAILMESSAGE'): ?>				  		  
					  		 <span><a href="<?php echo __URL('PLATFORM_MAIN/config/notifytemplate?type=email'); ?>">模板</a></span>
					  		<?php else: ?>
					  		<span><a href="<?php echo __URL('PLATFORM_MAIN/config/notifytemplate?type=sms'); ?>">模板</a></span>
					  		<?php endif; if($notify_obj['key'] == 'EMAILMESSAGE'): ?>				  		  
					  		 <span><a href="<?php echo __URL('PLATFORM_MAIN/config/businessnotifytemplate?type=email'); ?>">商家通知</a></span>
					  		<?php else: ?>
					  		<span><a href="<?php echo __URL('PLATFORM_MAIN/config/businessnotifytemplate?type=sms'); ?>">商家通知</a></span>
