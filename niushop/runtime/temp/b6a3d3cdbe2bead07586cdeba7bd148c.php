							...
							<div class="panel-body">
								<form class="form-horizontal" method="get">
									<div class="form-group">
										...
										<div class="col-md-4">
											<label class="switch" style="float:left;margin-right:10px;">
												<input type="checkbox" id="mobile_is_use" <?php if($mobile_message['is_use']=='1'): ?>checked="checked"<?php endif; ?>>
												<span></span>
											</label>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" id="APP_KEY" value="<?php echo $mobile_message['value']['appKey']; ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" id="SECRET_KEY" value="<?php echo $mobile_message['value']['secretKey']; ?>">
										</div>
									</div>
									<div class="line line-dashed line-lg pull-in"></div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" id="FREE_SIGN_NAME" value="<?php echo $mobile_message['value']['freeSignName']; ?>">
										</div>
									</div>
									<div class="line line-dashed line-lg pull-in"></div>
									<div class="form-group">
...
//设置短信通知
	function setMobileMessage(){
		...
		$.ajax({
			...
			success:function (data) {
				if (data["code"] > 0) {
					showMessage('success', data["message"],"<?php echo __URL('PLATFORM_MAIN/config/notifyindex'); ?>");
				}else{
	...
	function testSend(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('PLATFORM_MAIN/config/testsend'); ?>",
			data:{
