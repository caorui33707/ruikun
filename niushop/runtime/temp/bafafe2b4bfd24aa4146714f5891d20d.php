	...
	<div class="panel-body">
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="agent_name" value="<?php echo $data['agent_name']; ?>">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<select name="agent_type" id="agent_type" onchange="companyStye()" value="<?php echo $data['agent_type']; ?>" class="select-common">

						<option <?php if($data['agent_type'] == 1): ?> selected <?php endif; ?> value="1" >个人</option>
						<option <?php if($data['agent_type'] == 2): ?> selected <?php endif; ?>   value="2">公司</option>
					</select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="linkman_name" value="<?php echo $data['linkman_name']; ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="linkman_tel" value="<?php echo $data['linkman_tel']; ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<p>
						<select name="province" id="seleAreaNext" onchange="GetProvince();" value="<?php echo $data['province_id']; ?>" class="select-common">
							<option value="">请选择省</option>
						</select>
						<select name="city" id="seleAreaThird" onchange="getSelCity();" value="<?php echo $data['city_id']; ?>"  class="select-common">
							<option value="">请选择市</option>
						</select>
						<select name="district" id="seleAreaFouth" value="<?php echo $data['district_id']; ?>"  class="select-common">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="linkman_address" value="<?php echo $data['linkman_address']; ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="identity_card" value="<?php echo $data['identity_card']; ?>">
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-4">
					<p><img id="imgLogo" src="<?php echo $data['identity_card_photo']; ?>" class="imglogo"/></p>
                                            	<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		...
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
														...
														<input type="hidden" id="Logo" value="<?php echo $data['identity_card_photo']; ?>" />
													</span>
            ...
            <div class="form-group">
				...
				<div class="col-md-4">
					<textarea id="desc" name="desc" style="height: 300px; width: 500px; "><?php echo $data['desc']; ?></textarea>
				</div>
			</div>
			...
			<div id="company_stye" <?php if($data['agent_type'] == 1): ?> style="display: none" <?php endif; ?> >
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" class="form-control" id="business_licence_number" value="<?php echo $data['business_licence_number']; ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<p><img id="business_license" src="<?php echo $data['business_license']; ?>" class="imglogo"/></p>
						<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		<span style="width: 97px;height: 34px;position: absolute;left: 0;top: 0;z-index: 2;cursor: pointer;">
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" class="form-control" id="organization_code" value="<?php echo $data['organization_code']; ?>">
					</div>
				</div>
			...
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					<input type="hidden" id="up_id" value="<?php echo $data['id']; ?>" />
...
<input type="hidden" id="provinceid" value="<?php echo $data['province_id']; ?>">
<input type="hidden" id="cityid" value="<?php echo $data['city_id']; ?>">
<input type="hidden" id="districtid" value="<?php echo $data['district_id']; ?>">
...
//  		verify(ad_image, link_url);
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/config/updateShopAgant'); ?>",
			data : data,
			async : true,
			success : function(data) {
				if (data["code"] > 0) {
                   // companyEdit(data.id);
					showMessage('success', "添加成功","<?php echo __URL('PLATFORM_MAIN/config/shopAgantList'); ?>");
				}else{
