...
$(function(){
	...
	function LoadingInfo(pageIndex) {
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/member/weixinfanslist'); ?>",
			async : true,
			data : {
