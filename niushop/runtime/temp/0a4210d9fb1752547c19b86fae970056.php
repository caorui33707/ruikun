<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:43:"template/wap\default\Order\myOrderList.html";i:1513303782;s:30:"template/wap\default\base.html";i:1513303782;s:34:"template/wap\default\urlModel.html";i:1513303783;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        		...
        		success:function(data){
        			...
        			if(data['data'].length==0){
        				...
        				for(var i=0;i<data['data'].length;i++){
	        				...
	        				datahtml+='<div class="ordernumber" style="height:auto;overflow:hidden;line-height:22px;"><span class="order-num" style="font-size: 12px;">'+ordersitem['shop_name']+'   '+ordersitem['order_no']+'</span><span class="order-date" style="font-size: 12px;">'+timeStampTurnTime(ordersitem['create_time'])+'</span></div>';
