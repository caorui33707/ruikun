...
<script type="text/javascript">
		...
		$( "#dialog" ).dialog({				
            buttons: {
                "确定,#e57373": function() {
                    ...
                    $.ajax({
        				type : "post",
        				url : "<?php echo __URL('PLATFORM_MAIN/cms/deletearticleclass'); ?>",
        				async : true,
        				data : {
        					"class_id" : class_id
        				},
        				success : function(data) {
        					if (data["code"] > 0) {
        						showMessage('success', data["message"], "<?php echo __URL('PLATFORM_MAIN/Cms/articleClassList'); ?>");
        					}else{
	...
	$("table input").change(function(){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('PLATFORM_MAIN/Cms/modifyField'); ?>",
