...
$(function(){
	...
	<div class="member-main">
		<div class="box">
			<div class="tabmenu">
				<ul class="tab">
					<li class="active"><?php echo lang('member_my_coupon'); ?></li>
				</ul>
			</div>
			<div class="mar_top">
				<div id="tab_tab1_1">
					...
					<ul class="bonus_con">
						...
						<li>
							...
							<p><?php echo lang('preference_type'); ?>：<?php echo $vo['coupon_name']; ?></p>
							<p><?php echo lang('member_coupon_encoding'); ?>：<?php echo $vo['coupon_code']; ?></p>
							<p><?php echo lang('member_effective_time'); ?>：<?php echo lang('member_by'); ?><?php echo getTimeStampTurnTime($vo['end_time'] ); ?></p>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
					<?php else: ?>
					<div>
						<div class="emptyFrame"> <i class="user_coupon"></i><span><?php echo lang('member_no_coupon_yet'); ?>！</span> </div>
					</div>
					<?php endif; ?>
				</div>
			</div>
