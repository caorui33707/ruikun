...
<script>
	...
	function setConfigAjax(){
		...
		$.ajax({
			type:"post",
			url : "<?php echo __URL('PLATFORM_MAIN/config/seoconfig'); ?>",
			async : true,
			data : {
				"seo_title" : title,
				"seo_meta" : meta,
				...
				if(data['code'] > 0)
					{
						...
						location.href = "<?php echo __URL('PLATFORM_MAIN/config/seoconfig'); ?>";
					}else{
