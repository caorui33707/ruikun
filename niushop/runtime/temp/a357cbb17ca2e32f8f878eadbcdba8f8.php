...
<div class="row padder-v">
	<div class="col-sm-4">
		<a href="<?php echo __URL('PLATFORM_MAIN/Goods/addGoodsCategory'); ?>"
	...
	<table class="table table-striped b-t b-light text-sm">
		...
		<tbody>
			...
			<tr class="pid_0" style="height: 30px;">
				...
				<td class="center"><?php echo !empty($v1['is_visible'])?'是' : '否'; ?></td>
				<td class="center"><a
					href="<?php echo __URL('PLATFORM_MAIN/goods/updategoodscategory?category_id='.$v1['category_id']); ?>">修改</a>
			...
			<tr class="pid_<?php echo $v1['category_id']; ?>"
				...
				<td class="center"><?php echo !empty($v2['is_visible'])?'是' : '否'; ?></td>
				<td class="center"><a
					href="<?php echo __URL('PLATFORM_MAIN/goods/updategoodscategory?category_id='.$v2['category_id']); ?>">修改</a>
					<a href="javascript:void(0);"
			...
			<tr class="pid_<?php echo $v2['category_id']; ?> pid_<?php echo $v1['category_id']; ?>"
				...
				<td class="center"><?php echo !empty($v3['is_visible'])?'是' : '否'; ?></td>
				<td class="center"><a
					href="<?php echo __URL('PLATFORM_MAIN/goods/updategoodscategory?category_id='.$v3['category_id']); ?>">修改</a>
					<a href="javascript:void(0);"
...
$("table input").change(function(){
	...
	if(fieldvalue == ''){
		...
		$.ajax({
			type:"post",
			url:"<?php echo __URL('PLATFORM_MAIN/goods/modifygoodscategoryfield'); ?>",
			...
			buttons: {
				"确定": function() {
					...
					$.ajax({
						...
						success : function(data) {
							if(data['code'] > 0){
								showMessage('success', data["message"],"<?php echo __URL('PLATFORM_MAIN/goods/goodscategorylist'); ?>");
							}else{
	...
	*/
	function getCookieGoodsCategory(category_id){
		...
		$.ajax({
			url : "<?php echo __URL('PLATFORM_MAIN/goods/getquickgoods'); ?>",
			type : "post",
			async : false,
