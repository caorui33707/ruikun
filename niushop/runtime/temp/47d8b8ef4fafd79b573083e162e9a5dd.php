<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:42:"template/shop\blue\Member\agentUpdate.html";i:1526711654;s:28:"template/shop\blue\base.html";i:1513303781;s:32:"template/shop\blue\urlModel.html";i:1513303782;s:34:"template/shop\blue\controlTop.html";i:1513303781;s:41:"template/shop\blue\controlHeadSerach.html";i:1513303781;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1513303781;s:43:"template/shop\blue\controlHeadGoodType.html";i:1513303781;s:40:"template/shop\blue\controlCommonNav.html";i:1513303781;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1526717051;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1513303781;s:37:"template/shop\blue\controlBottom.html";i:1513303781;s:36:"template/shop\blue\controlLogin.html";i:1513303781;s:37:"template/shop\blue\baidu_js_push.html";i:1513303781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
$(function(){
	...
	<div class="member-main">
		<tr class="box">
			...
			<input type="hidden" id="agentid" value="<?php echo $agent_id; ?>" />
			<input type="hidden" id="agent_type_id" value="<?php echo $list['agent_type']; ?>" />
			<input type="hidden" id="hidUrl" value="" />
			<input type="hidden" id="provinceid" value="<?php echo $list['province_id']; ?>" />
			<input type="hidden" id="cityid" value="<?php echo $list['city_id']; ?>" />
			<input type="hidden" id="districtid" value="<?php echo $list['district_id']; ?>" />
			...
			<form action="" method="post" name="theForm">
				...
				<table width="100%" border="0" cellpadding="10" cellspacing="1"  style="background:  #fff">
					...
					<tr>
						...
						<td align="left" width="40%"><input name="agent_name" type="text" class="inputBg" id="agent_name" value="<?php echo $list['agent_name']; ?>" />(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right" width="10%">联系人姓名：</td>
						<td align="left" width="40%"><input name="linkman_name" type="text" class="inputBg" id="linkman_name"  value="<?php echo $list['linkman_name']; ?>"  />(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right">联系人电话：</td>
						<td align="left"><input name="linkman_tel" type="text" class="inputBg" id="linkman_tel"  value="<?php echo $list['linkman_tel']; ?>"  />(<?php echo lang('member_required'); ?>)</td>
					</tr>
					...
					<tr>
						...
						<td align="left" width="40%"><input name="linkman_address" type="text" class="inputBg" id="linkman_address"  value="<?php echo $list['linkman_address']; ?>" />(<?php echo lang('member_required'); ?>) </td>
					</tr>
					<tr>
						<td align="right">身份证：</td>
						<td align="left"><input name="identity_card" type="text" class="inputBg" id="identity_card"  value="<?php echo $list['identity_card']; ?>"  />(<?php echo lang('member_required'); ?>)</td>
					</tr>

					<tr >
						<td align="right" >上传身份证证件图</td>
						<td class="col-md-4">
							<p><img id="imgLogo" width="120px"  height="260px"  src="<?php echo $list['identity_card_photo']; ?>" class="imglogo"/></p>
							<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		...
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
														...
														<input type="hidden" id="Logo" value="<?php echo $list['identity_card_photo']; ?>" />
													</span>
				...
				<tr>
					...
					<td align="left"><textarea id="desc" name="desc" style="height: 300px; width: 500px; "><?php echo $list['desc']; ?></textarea></td>
				</tr>



				<tbody id="company_stye"  style="display: none"  > <!-- <?php if($data['agent_type'] == 1): ?> style="display: none" <?php endif; ?> -->

					<tr>
						<td  align="right">公司名</td>
						<td align="left">
							<input type="text" class="inputBg"   id="company_name" value="<?php echo $list['company_name']; ?>">
						</td>
					</tr>
					...
					<tr>
						...
						<td align="left">
							<input type="text" class="inputBg" id="business_licence_number" value="<?php echo $list['business_licence_number']; ?>">
						</td>
					</tr>
					...
					<tr >
						...
						<td class="col-md-4">
							<p><img id="business_license" width="120px"  height="260px"  src="<?php echo $list['business_license']; ?>" class="imglogo"/></p>
							<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
														<span style="width: 97px;height: 34px;position: absolute;left: 0;top: 0;z-index: 2;cursor: pointer;">
														<input hidefocus="true" size="1" class="input-file" name="file_upload"
															...
															<input type="hidden" id="logo_business_license" value="<?php echo $list['business_license']; ?>" />
														</span>
								<a class="btn btn-default"><i class="fa fa-cloud-upload text"></i><span class="text">上传图片</span></a>
							</a>
						</td>
					...
					<tr align="right">
						...
						<td align="left">
							<input type="text" class="inputBg" id="organization_code" value="<?php echo $list['organization_code']; ?>">
						</td>
					</tr>
					...
					<tr>
						<td colspan="4" align="center"><input type="button" name="button" class="common-btn"  value="修改代理商" onclick="saveAgent()"/></td>
					</tr>
				</table>
			</form>
...
<script src="__TEMP__/<?php echo $style; ?>/public/js/agentInsert.js"></script>
<script type="text/javascript">
...
$(function() {
   ...
   // $("input[name=agent_type]").
    ...
    $(":radio[name='agent_type'][value='" + agent_type_id + "']").prop("checked", "checked");
	//alert(agent_type_id);
