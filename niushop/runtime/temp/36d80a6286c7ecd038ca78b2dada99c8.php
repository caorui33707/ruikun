	...
	<div class="box">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr class="order-hd">
					...
					<td align="center" class="after-service baobei no-border-right order_goods_info" valign="middle">
						<div class="goods_desc last">
							...
							<div>
								<a href="<?php echo __URL('SHOP_MAIN/member/refunddetail','order_goods_id='.$order_item['order_goods_id']); ?>" style="text-decoration: underline; color: #E31939;"><?php echo lang('list_of_refund_return'); ?></a>
							</div>
							...
							<div>
								<a href="javascript:;" class="cancle" style="border: 1px solid #E31939; padding: 3px 8px; color: #E31939; line-height: 45px;" onclick="if(confirm('<?php echo lang('member_sure_cancel'); ?>?'))cancleDetail(<?php echo $order['order_id']; ?>,<?php echo $order_item['order_goods_id']; ?>)"><?php echo lang('member_cancellation_refund'); ?></a>
							</div>
							<?php endif; ?>
						</div>
					</td>
					...
					<td rowspan="<?php echo count($order['order_item_list']); ?>" align="center" class="trade-status no-border-right">
						...
						<a href="<?php echo __URL('SHOP_MAIN/member/orderdetail','orderid='.$order['order_id']); ?>" class="main-color"><?php echo lang('member_order_details'); ?></a>
					</td>
					<?php endif; ?>
				</tr>
			...
			<div class="myorder-none" style="padding:100px; text-align: center;">
				...
				<span class="none_03"><a href="<?php echo __URL('SHOP_MAIN/goods/goodslist'); ?>" style="color: #E31939;"><?php echo lang('member_look_around'); ?></a></span>
			</div>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_30158__=1;$__FOR_END_30158__=$page_count+1;for($i=$__FOR_START_30158__;$i < $__FOR_END_30158__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_15049__=1;$__FOR_END_15049__=$page_num+1;for($i=$__FOR_START_15049__;$i < $__FOR_END_15049__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_23248__=$page_count-$page_num+1;$__FOR_END_23248__=$page_count+1;for($i=$__FOR_START_23248__;$i < $__FOR_END_23248__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_27283__=$page-($page_num-1)/2;$__FOR_END_27283__=$page+($page_num-1)/2+1;for($i=$__FOR_START_27283__;$i < $__FOR_END_27283__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
