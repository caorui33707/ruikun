<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:40:"template/shop\blue\Member\userAgent.html";i:1526545885;s:28:"template/shop\blue\base.html";i:1513303781;s:32:"template/shop\blue\urlModel.html";i:1513303782;s:34:"template/shop\blue\controlTop.html";i:1513303781;s:41:"template/shop\blue\controlHeadSerach.html";i:1513303781;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1513303781;s:43:"template/shop\blue\controlHeadGoodType.html";i:1513303781;s:40:"template/shop\blue\controlCommonNav.html";i:1513303781;s:46:"template/shop\blue\Member\controlLeftMenu.html";i:1526635501;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1513303781;s:37:"template/shop\blue\controlBottom.html";i:1513303781;s:36:"template/shop\blue\controlLogin.html";i:1513303781;s:37:"template/shop\blue\baidu_js_push.html";i:1513303781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="member-main" id="user_security">
	<div class="box">
		<span class="title">代理申请</span>
		<div class="blank"></div>
		<div id="safe05">

			 <!-- 代理商申请 -->
			<div class="mc">
				<?php if($user_agent['admin_name'] != ''): ?>
				<div class="fore1">
					<s class="fore1_3"></s>
					<strong>代理商用户</strong>
				</div>
				<div class="fore2">
					<span class="ftx-03">申请代理商申请成功可以点击登录</span>
				</div>
				<div class="fore3">
					<input type="button" value="可以登录后台" onclick="location.href='<?php echo __URL('PLATFORM_MAIN/login'); ?>'" class="main-btn common-btn" />
				</div>
				<?php else: ?>
				<div class="fore1">
					<s class="fore1_1"></s>
				...
				<div class="fore2">
					<span tyle="color: #ED5854;">可以申请代理商</span>
				</div>
				<div class="fore3">
					<a href="javascript:;"  onclick="addAgent()" class="btn btn-7">申请代理商</a>
				</div>
				<?php endif; ?>
			</div>
				...
				<div id="find-box" class="uc_box">
					...
					<div class="item">
						...
						<label class="img" style="margin-left: 5px">
							<img class="verifyimg" src="<?php echo __URL('SHOP_MAIN/captcha'); ?>" onclick='this.src="<?php echo __URL('SHOP_MAIN/captcha?send='.time()); ?>"' alt="captcha" style="vertical-align: middle; cursor: pointer; height: 35px;" />
						</label>
...
function addAgent() {
	$.ajax({
		url:  __URL(SHOPMAIN+"/member/userAgent"), // SHOP_MAIN/member/useragent?atc=user_email
		data: {"is_post": 1  },
		type: "post",
		success: function (data) {
			//alert(JSON.stringify(res));
