...
<div class="row padder-v">
	<div class="col-sm-9">
		<a href="<?php echo __URL('PLATFORM_MAIN/Shop/addShopGroup'); ?>"
...
//查询用户列表
	function LoadingInfo(pageIndex) {
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/Shop/shopGroupList'); ?>",
			async : true,
			data : {
		...
		$( "#dialog" ).dialog({
            buttons: {
                "确定,#e57373": function() {
                    ...
                    $.ajax({
            			type : "post",
            			url : "<?php echo __URL('PLATFORM_MAIN/Shop/delShopGroup'); ?>",
            			async : true,
            			data : {
            			...
            			success : function(data) {
            				if(data["code"] > 0 ){
            					showMessage('success', data["message"],"<?php echo __URL('PLATFORM_MAIN/shop/shopgrouplist'); ?>");
            				}else{
