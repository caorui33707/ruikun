...
<section class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal">
			...
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<label class="col-sm-2 control-label">是否允许选择物流</label>
				<div class="col-md-4">
					<label class="radio inline" style="margin-bottom:10px;"><input type="radio" name="is_logistics" value="1" checked="checked" id="logisticsYes">启用</label> 
					<label class="radio inline" style="margin-bottom:10px;"><input type="radio" name="is_logistics" value="0" id="logisticsNo">禁用</label>
					<input type="hidden" id="is_logistics" value="<?php echo $shopSet['is_logistics']; ?>">
					<br/><a class="hint" style="color:#BBB;">是否允许用户选择物流</a>
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
...
$("#order_invoice_tax").keyup(function(){
	var reg = /^\d+(.{0,1})(\d{0,2})$/;
		...
		var shopping_back_points = $("#shopping_back_points").val();
		 $.ajax({
			...
			success:function (data) {
				if (data["code"] > 0) {
					showMessage('success', data["message"],"<?php echo __URL('PLATFORM_MAIN/config/shopset'); ?>");
				}else{
