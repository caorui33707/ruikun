...
function changeCategory(type){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/goods/changecategory'); ?>",
		data : {
			'pid' : pid
		},
		async : true,
	...
	function addGoodsBrandAjax(){
		...
		$.ajax({
			...
			success : function (data) {
				if (data["code"] > 0) {
					showMessage('success', "商品品牌添加成功","<?php echo __URL('PLATFORM_MAIN/goods/goodsbrandlist'); ?>");
				}else{
