...
-- Script date 2017/11/29 15:23:22
...
-- Table niushop_b2b2c_new.nc_cms_article does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_article_class
--

-- Table niushop_b2b2c_new.nc_cms_article_class does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_comment
--

-- Table niushop_b2b2c_new.nc_cms_comment does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_topic
--

-- Table niushop_b2b2c_new.nc_cms_topic does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.ns_account_order_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_period
--

-- Table niushop_b2b2c_new.ns_account_period does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_records
--

-- Table niushop_b2b2c_new.ns_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_return_records
--

-- Table niushop_b2b2c_new.ns_account_return_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_records
--

-- Table niushop_b2b2c_new.ns_account_withdraw_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_user_records
--

-- Table niushop_b2b2c_new.ns_account_withdraw_user_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_arrival_guide
--
INSERT INTO ns_arrival_guide VALUES
...
-- Table niushop_b2b2c_new.ns_attribute does not contain any data (it is empty)

-- 
-- Dumping data for table ns_attribute_value
--

-- Table niushop_b2b2c_new.ns_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_cart
--

-- Table niushop_b2b2c_new.ns_cart does not contain any data (it is empty)

-- 
-- Dumping data for table ns_click_fabulous
--

-- Table niushop_b2b2c_new.ns_click_fabulous does not contain any data (it is empty)

-- 
-- Dumping data for table ns_complain
--

-- Table niushop_b2b2c_new.ns_complain does not contain any data (it is empty)

-- 
-- Dumping data for table ns_complain_subject
--

-- Table niushop_b2b2c_new.ns_complain_subject does not contain any data (it is empty)

-- 
-- Dumping data for table ns_complain_talk
--

-- Table niushop_b2b2c_new.ns_complain_talk does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult
--

-- Table niushop_b2b2c_new.ns_consult does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult_type
--

-- Table niushop_b2b2c_new.ns_consult_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon
--

-- Table niushop_b2b2c_new.ns_coupon does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_goods
--

-- Table niushop_b2b2c_new.ns_coupon_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_type
--

-- Table niushop_b2b2c_new.ns_coupon_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_company
--

-- Table niushop_b2b2c_new.ns_express_company does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping
--

-- Table niushop_b2b2c_new.ns_express_shipping does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.ns_gift_grant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods
--

-- Table niushop_b2b2c_new.ns_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute
--

-- Table niushop_b2b2c_new.ns_goods_attribute does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_deleted
--

-- Table niushop_b2b2c_new.ns_goods_attribute_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_value
--

-- Table niushop_b2b2c_new.ns_goods_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_brand
--

-- Table niushop_b2b2c_new.ns_goods_brand does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_category
--

-- Table niushop_b2b2c_new.ns_goods_category does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_category_block
--

-- Table niushop_b2b2c_new.ns_goods_category_block does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_comment
--

-- Table niushop_b2b2c_new.ns_goods_comment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_deleted
--

-- Table niushop_b2b2c_new.ns_goods_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_evaluate
--

-- Table niushop_b2b2c_new.ns_goods_evaluate does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_group
--

-- Table niushop_b2b2c_new.ns_goods_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku
--

-- Table niushop_b2b2c_new.ns_goods_sku does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_deleted
--

-- Table niushop_b2b2c_new.ns_goods_sku_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture
--

-- Table niushop_b2b2c_new.ns_goods_sku_picture does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture_delete
--

-- Table niushop_b2b2c_new.ns_goods_sku_picture_delete does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_spec
--

-- Table niushop_b2b2c_new.ns_goods_spec does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_spec_value
--

-- Table niushop_b2b2c_new.ns_goods_spec_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_inform
--

-- Table niushop_b2b2c_new.ns_inform does not contain any data (it is empty)

-- 
-- Dumping data for table ns_inform_subject
--

-- Table niushop_b2b2c_new.ns_inform_subject does not contain any data (it is empty)

-- 
-- Dumping data for table ns_inform_subject_type
--

-- Table niushop_b2b2c_new.ns_inform_subject_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member
--

-- Table niushop_b2b2c_new.ns_member does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account
--

-- Table niushop_b2b2c_new.ns_member_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account_records
--

-- Table niushop_b2b2c_new.ns_member_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_balance_withdraw
--

-- Table niushop_b2b2c_new.ns_member_balance_withdraw does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_bank_account
--

-- Table niushop_b2b2c_new.ns_member_bank_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_express_address
--

-- Table niushop_b2b2c_new.ns_member_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_favorites
--

-- Table niushop_b2b2c_new.ns_member_favorites does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_feedback
--

-- Table niushop_b2b2c_new.ns_member_feedback does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_gift
--

-- Table niushop_b2b2c_new.ns_member_gift does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.ns_member_recharge does not contain any data (it is empty)

-- 
-- Dumping data for table ns_notice
--

-- Table niushop_b2b2c_new.ns_notice does not contain any data (it is empty)

-- 
-- Dumping data for table ns_offpay_area
--

-- Table niushop_b2b2c_new.ns_offpay_area does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order
--

-- Table niushop_b2b2c_new.ns_order does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_action
--

-- Table niushop_b2b2c_new.ns_order_action does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods
--

-- Table niushop_b2b2c_new.ns_order_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_express
--

-- Table niushop_b2b2c_new.ns_order_goods_express does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_promotion_details
--

-- Table niushop_b2b2c_new.ns_order_goods_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_payment
--

-- Table niushop_b2b2c_new.ns_order_payment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_pickup
--

-- Table niushop_b2b2c_new.ns_order_pickup does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_promotion_details
--

-- Table niushop_b2b2c_new.ns_order_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund
--

-- Table niushop_b2b2c_new.ns_order_refund does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund_account_records
--

-- Table niushop_b2b2c_new.ns_order_refund_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shipping_fee
--

-- Table niushop_b2b2c_new.ns_order_shipping_fee does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shop_return
--

-- Table niushop_b2b2c_new.ns_order_shop_return does not contain any data (it is empty)

-- 
-- Dumping data for table ns_pickup_point
--

-- Table niushop_b2b2c_new.ns_pickup_point does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_adv
--

-- Table niushop_b2b2c_new.ns_platform_adv does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.ns_platform_block does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend
--

-- Table niushop_b2b2c_new.ns_platform_goods_recommend does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend_class
--

-- Table niushop_b2b2c_new.ns_platform_goods_recommend_class does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.ns_platform_link does not contain any data (it is empty)

-- 
-- Dumping data for table ns_point_config
--
INSERT INTO ns_point_config VALUES
(1, 0, 0, 0.00, '', 1509418871, 1511779317);

-- 
-- Dumping data for table ns_promotion_bundling
--

-- Table niushop_b2b2c_new.ns_promotion_bundling does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling_goods
--

-- Table niushop_b2b2c_new.ns_promotion_bundling_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount
--

-- Table niushop_b2b2c_new.ns_promotion_discount does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount_goods
--

-- Table niushop_b2b2c_new.ns_promotion_discount_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_full_mail
--

-- Table niushop_b2b2c_new.ns_promotion_full_mail does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift
--

-- Table niushop_b2b2c_new.ns_promotion_gift does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift_goods
--

-- Table niushop_b2b2c_new.ns_promotion_gift_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong
--

-- Table niushop_b2b2c_new.ns_promotion_mansong does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_goods
--

-- Table niushop_b2b2c_new.ns_promotion_mansong_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_rule
--

-- Table niushop_b2b2c_new.ns_promotion_mansong_rule does not contain any data (it is empty)

-- 
-- Dumping data for table ns_reward_rule
--

-- Table niushop_b2b2c_new.ns_reward_rule does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.ns_shop_account_money_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_account_proceeds_records
--

-- Table niushop_b2b2c_new.ns_shop_account_proceeds_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_account_profit_records
--

-- Table niushop_b2b2c_new.ns_shop_account_profit_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_account_records
--

-- Table niushop_b2b2c_new.ns_shop_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_account_return_records
--

-- Table niushop_b2b2c_new.ns_shop_account_return_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_account_withdraw_records
--

-- Table niushop_b2b2c_new.ns_shop_account_withdraw_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_ad
--

-- Table niushop_b2b2c_new.ns_shop_ad does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_apply
--

-- Table niushop_b2b2c_new.ns_shop_apply does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_bank_account
--

-- Table niushop_b2b2c_new.ns_shop_bank_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_coin_records
--

-- Table niushop_b2b2c_new.ns_shop_coin_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_express_address
--

-- Table niushop_b2b2c_new.ns_shop_express_address does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.ns_shop_order_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_order_goods_return
--

-- Table niushop_b2b2c_new.ns_shop_order_goods_return does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_order_return
--

-- Table niushop_b2b2c_new.ns_shop_order_return does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.ns_shop_withdraw does not contain any data (it is empty)

-- 
-- Dumping data for table ns_supplier
--

-- Table niushop_b2b2c_new.ns_supplier does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.sys_album_picture does not contain any data (it is empty)
...
(45, 0, 'SEO_TITLE', '', '标题附加字', 1, 1496751194, 1510135268),
(46, 0, 'SEO_META', '', '商城关键词', 1, 1496751194, 1510135268),
(47, 0, 'SEO_DESC', '', '关键词描述', 1, 1496751194, 1510135268),
(48, 0, 'SEO_OTHER', '', '其他页头信息', 1, 1496751194, 1510135268),
(107, 0, 'ORDER_DELIVERY_PAY', '0', '是否开启货到付款', 1, 1496825466, 1510644858),
(108, 0, 'WITHDRAW_BALANCE', '{"withdraw_cash_min":"1","withdraw_multiple":"1","withdraw_poundage":0,"withdraw_message":""}', '会员余额提现设置', 1, 1496830716, 1511582483),
...
(141, 0, 'COPYRIGHT_LOGO', '', '版权logo', 1, 1509335724, 0),
(142, 0, 'COPYRIGHT_META', '', '备案号', 1, 1509335724, 0),
(143, 0, 'COPYRIGHT_LINK', '', '版权链接', 1, 1509335724, 0),
(144, 0, 'COPYRIGHT_DESC', '', '版权信息', 1, 1509335724, 0),
(145, 0, 'COPYRIGHT_COMPANYNAME', '', '公司名称', 1, 1509335725, 0),
...
(151, 0, 'SEO_TITLE', '', '标题附加字', 1, 1510214503, 0),
(152, 0, 'SEO_META', '', '商城关键词', 1, 1510214503, 0),
(153, 0, 'SEO_DESC', '', '关键词描述', 1, 1510214503, 0),
(154, 0, 'SEO_OTHER', '', '其他页头信息', 1, 1510214503, 0),
...
(207, 0, 'SEO_TITLE', '', '标题附加字', 1, 1510221108, 0),
(208, 0, 'SEO_META', '', '商城关键词', 1, 1510221108, 0),
(209, 0, 'SEO_DESC', '', '关键词描述', 1, 1510221108, 0),
(210, 0, 'SEO_OTHER', '', '其他页头信息', 1, 1510221108, 0),
...
(407, 0, 'SEO_TITLE', '', '标题附加字', 1, 1510885322, 0),
(408, 0, 'SEO_META', '', '商城关键词', 1, 1510885322, 0),
(409, 0, 'SEO_DESC', '', '关键词描述', 1, 1510885322, 0),
(410, 0, 'SEO_OTHER', '', '其他页头信息', 1, 1510885322, 0);

-- 
-- Dumping data for table sys_custom_template
--

-- Table niushop_b2b2c_new.sys_custom_template does not contain any data (it is empty)
...
(546, '文章', 'platform', 'cms', 'articlelist', 0, 1, 'cms/articlelist', 1, 0, 5, '该页面显示所有文章列表。///可以对文章进行添加、修改、删除操作。///可以通过关键字进行搜索。<br>', '', 'icon-cms', 1, 0, 0),
...
(636, '微信', 'platform', 'wchat', 'config', 0, 1, 'wchat/config', 1, 0, 3, '该页面显示微信公众号的相关配置信息。', '', 'icon-weixin', 1, 0, 0),
...
(10000, 'NIU云', 'admin', 'upgrade', 'onlineupdate', 0, 1, 'upgrade/onlineupdate', 0, 0, 100, '', '', '', 1, 1499343016, 1499343016),
...
-- Table niushop_b2b2c_new.sys_user does not contain any data (it is empty)

-- 
-- Dumping data for table sys_user_admin
--

-- Table niushop_b2b2c_new.sys_user_admin does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.sys_user_log does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_devolution
--

-- Table niushop_b2b2c_new.sys_version_devolution does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_patch
--

-- Table niushop_b2b2c_new.sys_version_patch does not contain any data (it is empty)
...
(1, 'Niushop开源商城', 'public/static/images/default_img_url/logo.png', '开源商城', '', '', 1, '山西省太原市', 'public/static/images/default_img_url/qrcode.png', 'http://www.niushop.com.cn/', '', '400-886-7993', '', '', 1, '', '对不起，牛酷商城维护中，大家敬请期待...', 1, 0, 1477452112, 1511779146, 0, '');

-- 
-- Dumping data for table sys_weixin_auth
--

-- Table niushop_b2b2c_new.sys_weixin_auth does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_default_replay
--

-- Table niushop_b2b2c_new.sys_weixin_default_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_fans
--

-- Table niushop_b2b2c_new.sys_weixin_fans does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_follow_replay
--

-- Table niushop_b2b2c_new.sys_weixin_follow_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_functions_button
--

-- Table niushop_b2b2c_new.sys_weixin_functions_button does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_instance_msg
--

-- Table niushop_b2b2c_new.sys_weixin_instance_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_key_replay
--

-- Table niushop_b2b2c_new.sys_weixin_key_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media
--

-- Table niushop_b2b2c_new.sys_weixin_media does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media_item
--

-- Table niushop_b2b2c_new.sys_weixin_media_item does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_menu
--

-- Table niushop_b2b2c_new.sys_weixin_menu does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_msg_template
--

-- Table niushop_b2b2c_new.sys_weixin_msg_template does not contain any data (it is empty)
...
-- Table niushop_b2b2c_new.sys_weixin_user_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_user_msg_replay
--

-- Table niushop_b2b2c_new.sys_weixin_user_msg_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_wexin_onekeysubscribe
--

-- Table niushop_b2b2c_new.sys_wexin_onekeysubscribe does not contain any data (it is empty)
