...
// 		alert();
    ...
    <div class="user-right" >
        ...
        <div class="tabmenu">
          <ul class="tab pngFix">
            <li class="first active"><?php echo lang('member_account_balance'); ?></li>
          </ul>
        </div>
<!--            <span class="integral_title" style="display:inline-block;"><b><?php echo $shopname; ?>积分操作明细(可用积分:<span id="sum"><?php echo $sum; ?></span>)</b></span> -->
            ...
            <div class="chongzhi" onclick="recharge();"><a href="javascript:;" style="color:#fff;"><?php echo lang('member_recharge_balance'); ?></a></div>
 <?php if($total_count != ''): ?>           
		<table>
            <tr align="center">
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_22943__=1;$__FOR_END_22943__=$page_count+1;for($i=$__FOR_START_22943__;$i < $__FOR_END_22943__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_30526__=1;$__FOR_END_30526__=$page_num+1;for($i=$__FOR_START_30526__;$i < $__FOR_END_30526__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_7161__=$page_count-$page_num+1;$__FOR_END_7161__=$page_count+1;for($i=$__FOR_START_7161__;$i < $__FOR_END_7161__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_17088__=$page-($page_num-1)/2;$__FOR_END_17088__=$page+($page_num-1)/2+1;for($i=$__FOR_START_17088__;$i < $__FOR_END_17088__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
