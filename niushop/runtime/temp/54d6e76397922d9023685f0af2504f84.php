...
<div class="row padder-v">
	<div class="col-sm-9" style="width:73%;">
		<a href="<?php echo __URL('PLATFORM_MAIN/member/addmemberlevel'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> 添加等级 </a>
	</div>
</div>
