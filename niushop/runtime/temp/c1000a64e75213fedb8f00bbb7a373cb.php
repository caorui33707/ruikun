			...
			<tbody>
				<tr>
					...
					<td align="right" width="150">
						<a href="javascript:selcart_submit();" class="jmcheckout js-settlement" style="color:#ffffff"><?php echo lang('goods_settle_accounts'); ?></a>
					</td>
				</tr>
			</tbody>
		</table>
...
<!-- <div class="tell-me-form" style="display: none; left: 701.5px; top: 269px;" id="tell-me-table">
	<div class="pop-header"><span>到货通知</span>
		<a href="javascript:closeDiv1()" title="<?php echo lang('goods_add_cart'); ?>" class="tell-me-close"></a>
	</div>
			...
			<tbody>
				...
				<tr>
					<td width="30%" align="right">
						<font class="main-color">*</font><?php echo lang('goods_number'); ?>：</td>
					<td align="left">
