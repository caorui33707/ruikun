...
//分页数据
 function LoadingInfo(pageIndex) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('PLATFORM_MAIN/config/shopnavigationlist'); ?>",
		async : true,
		data : {
