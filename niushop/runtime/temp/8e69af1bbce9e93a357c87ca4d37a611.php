	...
	<div class="panel-body">
		<form class="form-horizontal" id="user_form" name="form">
			<div class="form-group">
				...
				<div class="col-md-2">
					<input type="number" class="form-control" style="width: 80px" id="agent1" name="admin_name" value="<?php echo $agent_list['agent1']; ?>" required>
				</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="number" name="user_password" style="width: 80px" id="agent2" class="form-control" value="<?php echo $agent_list['agent2']; ?>" required>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="number" name="user_password" style="width: 80px" id="agent3" class="form-control" value="<?php echo $agent_list['agent3']; ?>" required>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="number" name="user_password" style="width: 80px" id="agent4" class="form-control" value="<?php echo $agent_list['agent4']; ?>" required>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="number" name="user_password" style="width: 80px" id="agent5" class="form-control" value="<?php echo $agent_list['agent5']; ?>" required>
				</div>
...
$().ready(function() {
	...
	function addUserAjax() {
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/config/agentSave'); ?>",
            dataType: "json",
            data : data,
			...
			success : function(data) {  console.log(data);
				if (data['code'] > 0) {
					location.href = "<?php echo __URL('PLATFORM_MAIN/config/agentSave'); ?>";
				}
			}
		});
	}
