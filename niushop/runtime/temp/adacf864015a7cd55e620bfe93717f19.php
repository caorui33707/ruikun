...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url : "<?php echo __URL('PLATFORM_MAIN/config/pictureUploadSetting'); ?>",
		data : {
		...
		success : function(data){
			if(data['code'] > 0){
				showMessage('success', data["message"], "<?php echo __URL('PLATFORM_MAIN/config/pictureUploadSetting'); ?>");
			}else{
