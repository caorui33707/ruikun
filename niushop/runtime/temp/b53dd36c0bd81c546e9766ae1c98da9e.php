<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"template/wap\default\Member\shopCollection.html";i:1513303782;s:30:"template/wap\default\base.html";i:1513303782;s:34:"template/wap\default\urlModel.html";i:1513303783;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function loadingInfo(page,type){
	...
	$.ajax({
		type : "post",
		url : __URL(APPMAIN + "/member/shopCollection"),
			...
			if(data['data'].length > 0){
				for (var i = 0; i < data['data'].length; i++) {
					...
					if(item['shop_id'] != null){
						...
						html +=	'<div class="goods_img" onclick="location.href=\''+__URL('APP_MAIN/shop/index?shop_id='+item.fav_id)+'\'">';
						html += '<img src="'+__IMG(item.shop_logo)+'" alt="" class="pic"  onerror="this.src=\'__TEMP__/<?php echo $style; ?>/public/images/default_shop_logo.png\'">';
						html += '</div>';
						html += '<div class="data_info">';
						html += '<p class="goods_name" onclick="location.href=\''+__URL('APP_MAIN/shop/index?shop_id='+item.fav_id)+'\'">'+item['shop_name']+'</p>';
						html += '<div class="price_share">';
						html += '<span class="cancel_collection" onclick="javascript:cancelFavorites('+item['fav_id']+',\'shop\',this);">取消收藏</span>';
						html += '</div>';
						html += '</div>';
						html += '</div>';
					}
