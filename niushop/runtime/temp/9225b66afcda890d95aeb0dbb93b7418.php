...
// 		alert();
  ...
  <div class="user-right"> 
	<div class="box">
		<div class="tabmenu">
			<ul class="tab">
				<li class="first active"><a><?php echo lang('member_my_collection'); ?></a><span style="font-size:12px;margin-left:15px;display: none;">(<?php echo lang('concerned_following_items_to_receive_latest_developments'); ?>)</span></li>
			</ul>
		</div>
		<div class="mar_top">
				...
				<tbody>
					<tr>
						<td colspan="2" class="pic-model">
							...
							<?php if($page_count == 0): ?>
								<div class="emptyFrame clearfix" style="cursor: pointer;"> <i class="user_bg"></i><span><?php echo lang('member_collect_favorite_goods'); ?>！</span> </div>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_6800__=1;$__FOR_END_6800__=$page_count+1;for($i=$__FOR_START_6800__;$i < $__FOR_END_6800__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_20819__=1;$__FOR_END_20819__=$page_num+1;for($i=$__FOR_START_20819__;$i < $__FOR_END_20819__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_27970__=$page_count-$page_num+1;$__FOR_END_27970__=$page_count+1;for($i=$__FOR_START_27970__;$i < $__FOR_END_27970__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_22413__=$page-($page_num-1)/2;$__FOR_END_22413__=$page+($page_num-1)/2+1;for($i=$__FOR_START_22413__;$i < $__FOR_END_22413__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
