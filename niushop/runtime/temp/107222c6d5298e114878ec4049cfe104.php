...
<div class="user-right"> 
	<div class="account">
		...
		<div class="notice">
			<i></i>
			<span><?php echo lang('member_user_center_bulletin'); ?>：</span>
		...
		<div class="money">
			<ul class="clearfix">
				...
				<li class="first">
					<div class="title"><span><?php echo lang('member_balance'); ?></span></div>
					<div class="pic">
						<a href="<?php echo __URL('SHOP_MAIN/member/balancelist'); ?>"><i class="user_bg"></i></a>
					</div>
					<p><a href="<?php echo __URL('SHOP_MAIN/member/balancelist'); ?>"><?php echo $balance; ?></a></p>
				</li>
				
				<li class="third">
					<div class="title"><span><?php echo lang('goods_integral'); ?></span></div>
					<div class="pic">
						<a href="<?php echo __URL('SHOP_MAIN/member/integrallist'); ?>"><i class="user_bg"></i></a>
					</div>
					<p><a href="<?php echo __URL('SHOP_MAIN/member/integrallist'); ?>"><?php echo $point; ?><?php echo lang('goods_integral'); ?></a></p>
				</li>
				
				<li class="second">
					<div class="title"><span><?php echo lang('coupon'); ?></span></div>
					<div class="pic">
						<a href="<?php echo __URL('SHOP_MAIN/member/vouchers'); ?>"><i class="user_bg"></i></a>
					</div>
					<p><a href="<?php echo __URL('SHOP_MAIN/member/vouchers'); ?>"><?php echo $vouchersCount; ?> <?php echo lang('member_zhang'); ?></a></p>
				</li>
			</ul>
		</div>
		...
		<div class="security">
			...
			<div class="improve">
				<p><?php echo lang('member_safety_level'); ?></p>
				<span class="improve-name"><?php echo lang('member_security'); ?></span>
			...
			<div class="improve">
				<p><?php echo lang('member_safety_level'); ?></p>
				<span class="improve-name"><?php echo lang('member_good'); ?></span>
			...
			<div class="improve">
				<p><?php echo lang('member_safety_level'); ?></p>
				<span class="improve-name"><?php echo lang('goods_commonly'); ?> </span>
				<i class="low"><em></em></i> 
				<a href="<?php echo __URL('SHOP_MAIN/member/usersecurity'); ?>" title="<?php echo lang('member_security_level'); ?>"><?php echo lang('member_promote'); ?> &gt;</a>
			</div>
			...
			<div class="safe-info clearfix">
				<div class="safe-type phone">
					<i class="tit-icon"></i>
					<span class="safe-name"><?php echo lang('member_phone'); ?>：
					<?php if($member_info['user_info']['user_tel'] != ''): ?>
						<span class="user_safe_info" title="<?php echo $member_info['user_info']['user_tel']; ?>"><?php echo $member_info['user_info']['user_tel']; ?></span></span>
						<a class="res jc" href="<?php echo __URL('SHOP_MAIN/member/usersecurity','atc=user_mobile'); ?>"><?php echo lang('member_unbound'); ?></a>
					<?php else: ?>
					</span>
						<a class="res" href="<?php echo __URL('SHOP_MAIN/member/usersecurity','atc=user_mobile'); ?>"><?php echo lang('member_no_bound'); ?></a>
					<?php endif; ?>
				</div>
				
				<div class="safe-type mail">
					<i class="tit-icon"></i>
					<span class="safe-name"><?php echo lang('mailbox'); ?>：
					<?php if($member_info['user_info']['user_email'] != ''): ?>
					<span class="user_safe_info" title="<?php echo $member_info['user_info']['user_email']; ?>"><?php echo $member_info['user_info']['user_email']; ?></span></span>
					<a class="res jc" href="<?php echo __URL('SHOP_MAIN/member/usersecurity','atc=user_email'); ?>"><?php echo lang('member_unbound'); ?></a>
					<?php else: ?>
					</span><a class="res" href="<?php echo __URL('SHOP_MAIN/member/usersecurity','atc=user_email'); ?>"><?php echo lang('member_no_bound'); ?></a>
					<?php endif; ?>
				</div>
			</div>
		...
		<div class="middle order">
			<div class="line1 clearfix">
				<div class="title"><i></i><span><?php echo lang('member_transaction_reminder'); ?></span></div>
				<div class="status">
					<ul>
						<li>
							<a href="<?php echo __URL('SHOP_MAIN/member/orderlist','status=0'); ?>" title="<?php echo lang('member_pending_payment'); ?>"><?php echo lang('member_pending_payment'); ?><span><?php echo $order_status_num['wait_pay']; ?></span></a>
							<i></i>
						</li>
						<li>
							<a href="<?php echo __URL('SHOP_MAIN/member/orderlist','status=5'); ?>" title="<?php echo lang('member_pending_evaluation'); ?>"><?php echo lang('member_pending_evaluation'); ?><span><?php echo $order_status_num['wait_evaluate']; ?></span></a>
						</li>
					</ul>
				</div>
				<a class="more" href="<?php echo __URL('SHOP_MAIN/member/orderlist'); ?>" title="<?php echo lang('member_view_all_orders'); ?>"><?php echo lang('member_view_all_orders'); ?> &gt;</a>
			</div>
				...
				<ul class="listLine clearfix">
					<li>
						<ul class="img clearfix">
							<li>
								<a href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$order['order_item_list'][0]['goods_id']); ?>" title="<?php echo $order['order_item_list']['0']['goods_name']; ?>" target="_blank">
									<img src="<?php echo __IMG($order['order_item_list'][0]['picture']['pic_cover_small']); ?>" alt="<?php echo $order['order_item_list']['0']['goods_name']; ?>" /> 
								</a>
								<span class="order-num"><?php echo count($order['order_item_list']); ?></span>
							</li>
						</ul>
					</li>
					<li class="name">
					...
					<li class="attr"></li>
					<li class="type">
						<a class="cancel-order" href="javascript:;" onclick="cancle_order(<?php echo $order['order_id']; ?>)"><?php echo lang('member_cancellation_order'); ?></a>
					</li>
					<li class="check">
			...
			<?php else: ?>
			<div class="emptyFrame clearfix"><i class="user_bg"></i><span><?php echo lang('goods_empty_and_look'); ?>！</span></div>
			<?php endif; ?>
		</div>
		
		<div class="middle cart">
			<div class="line1 clearfix">
				<div class="title"><i></i><span><?php echo lang('member_my_shopping_cart'); ?></span></div>
			</div>
					...
					<div style="float:left; height:auto; width:auto">
						...
						<?php if(is_array($cart_list) || $cart_list instanceof \think\Collection || $cart_list instanceof \think\Paginator): if( count($cart_list)==0 ) : echo "" ;else: foreach($cart_list as $key=>$cart): ?>
							<li>
								...
								<p><?php echo lang('goods_sale_price'); ?>：<font>￥<?php echo $cart['price']; ?></font></p>
							</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
					</div>
				</div>
				<p class="more"><a href="<?php echo __URL('SHOP_MAIN/goods/cart'); ?>" target="_blank" title="<?php echo lang('member_view_shopping_cart'); ?>"><?php echo lang('member_view_shopping_cart'); ?> &gt;</a></p>
			</div>
			<?php else: ?>
			<div class="emptyFrame_cart"><i class="user_bg"></i><span><?php echo lang('goods_empty_and_look'); ?>！</span></div>
			<?php endif; ?>
		</div>

		<div class="middle collect">
			<div class="line1" id="tab1">
				<div class="title"><i></i><span><?php echo lang('member_merchandise_collection'); ?></span></div>
			</div>
			...
			<div class="tab_con" style="width:100%">
				<div id="con_tab_1">
					...
					<div class="colList clearfix">
							...
							<?php if(is_array($goods_collection_list) || $goods_collection_list instanceof \think\Collection || $goods_collection_list instanceof \think\Paginator): if( count($goods_collection_list)==0 ) : echo "" ;else: foreach($goods_collection_list as $k=>$goods): if(!(empty($goods['goods_id']) || (($goods['goods_id'] instanceof \think\Collection || $goods['goods_id'] instanceof \think\Paginator ) && $goods['goods_id']->isEmpty()))): ?>
									<li class="first">
										<a href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$goods['goods_id']); ?>" title="<?php echo $goods['goods_name']; ?>" target="_blank" class="img">
											...
											<span>￥<?php echo $goods['promotion_price']; ?></span>
										</a>
						...
						<p class="more"><a href="<?php echo __URL('SHOP_MAIN/member/goodscollectionlist'); ?>" title="<?php echo lang('member_check_out_collection'); ?>"><?php echo lang('member_check_out_collection'); ?> &gt;</a></p>
					</div>
					<?php else: ?>
					<div class="emptyFrame_collect"> <i class="user_bg"></i><span><?php echo lang('goods_empty_and_look'); ?>！</span></div> 
					<?php endif; ?>
				</div>
			</div>
		</div>
