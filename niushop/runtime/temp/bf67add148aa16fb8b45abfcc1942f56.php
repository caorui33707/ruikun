<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"template/shop\default\Login\login.html";i:1513303782;s:35:"template/shop\default\urlModel.html";i:1513303782;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="user_head_bg">
	<div class="user_head">
		<div class="logobox" style="padding-top:11px;"><a href="<?php echo __URL('SHOP_MAIN'); ?>" class="web-logo-a"><img src="<?php echo __IMG($web_info['logo']); ?>" border="0" class="weblogo"></a></div>
		<div class="logotxts" style="color:#333333;hiehgt:80px;line-height:80px;margin-top:10px;">|&nbsp;&nbsp;会员登录&nbsp;&nbsp;</div>
		<div class="reg">
			<span style="float:right;">没有账号？
				<a href="<?php echo __URL('SHOP_MAIN/login/registerbox'); ?>" style="color:white; text-decoration: none;line-height: 40px;">
					<span style="display:inline-block;width:100px;background-color:rgba(73, 200, 239, 0.72);line-height:43px;text-align:center;border-radius:4px;">立即注册</span>
				</a>
			</span>
		</div>
		<div class="clear"></div>
...
<div class="ban_box">
	...
	<div class="maind">
		<div class="login"><!--  style="top: -445px;" -->
			<!--用户名密码登录 -->
...
<!-- 						<div class="imgbg"></div> -->
					...
					<div class="txtbox link_gray6">
						...
						<div class="td2" style="float: right;text-align: left;"><a href="<?php echo __URL('SHOP_MAIN/login/findpasswd'); ?>">忘记密码?</a></div>
					</div>
					...
					<div class="qqbox">
						...
						<div class="appsparent" style="display: inline-block; float: right;margin-top: -55px;margin-right: 18px;">
							<div class="apps">
							<?php if($qq_info['is_use'] == 1): ?><a class="ali qq" href="<?php echo __URL('APP_MAIN/login/oauthlogin','type=QQLOGIN'); ?>" title="腾讯QQ账号登录"></a><?php endif; if($Wchat_info['is_use'] == 1): ?><a class="ali taobao" href="<?php echo __URL('APP_MAIN/login/oauthlogin','type=WCHAT'); ?>"  title="微信授权登录"></a><?php endif; ?>
							</div>
						</div>
						<div class="clear"></div>
					</div>
...
<div class="footer_min" id="footer">
	<div class="links link_gray6">
		<a target="_blank" href="<?php echo __URL('SHOP_MAIN/index/index'); ?>">网站首页</a>|
		<a target="_blank" href="<?php echo __URL('SHOP_MAIN/helpcenter/index','id=2'); ?>">常见问题</a>|
		<a target="_blank" href="<?php echo __URL('SHOP_MAIN/helpcenter/index','id=1'); ?>">购物流程</a>|
		<a target="_blank" href="<?php echo __URL('SHOP_MAIN/helpcenter/index','id=9'); ?>">退款说明</a>|
		<a target="_blank" href="http://www.5law.cn/">法律申明</a>|
		<a target="_blank" href="<?php echo __URL('SHOP_MAIN/helpcenter/index','id=10'); ?>">退款流程</a>|
		<a target="_blank" href="<?php echo __URL('SHOP_MAIN/helpcenter/index','id=12'); ?>">商家入驻</a>|
		<a target="_blank" href="<?php echo __URL('SHOP_MAIN/helpcenter/index','id=11'); ?>">退款政策</a> 
	</div>
	<div class="txt" style="color:#666;" id="bottom_copyright" >
		<p>
		<span id="copyright_desc" style="font-size: 12px;"></span>
		<br/>
			<a href="http://www.niushop.com.cn" target="_blank" style="text-decoration: none;color:#666;" id="copyright_companyname"></a>
...
function btnlogin() {
	...
	//alert($("#txtName").val());
	if(userName == "请输入账号" || userName == "" || userName == undefined || userName == null ) {
...
var str="";
if(data[0]['adv_image']==''){
	str+='<li style="display: list-item;background: url(__TEMP__/<?php echo $style; ?>/public/images/red_login_banner.png) no-repeat center;background-size: auto">';
	str+='<a href="javascript:;" target="_blank">&nbsp;</a>';
	str+='</li>';
}else{
