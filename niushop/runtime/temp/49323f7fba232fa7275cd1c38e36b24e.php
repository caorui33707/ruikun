<?php if (!defined('THINK_PATH')) exit(); /*a:21:{s:42:"template/shop\default\Goods\goodsInfo.html";i:1513303782;s:31:"template/shop\default\base.html";i:1513303782;s:35:"template/shop\default\urlModel.html";i:1513303782;s:37:"template/shop\default\controlTop.html";i:1513303782;s:44:"template/shop\default\controlHeadSerach.html";i:1513303782;s:47:"template/shop\default\controlHeadSearchAdv.html";i:1513303782;s:46:"template/shop\default\controlHeadGoodType.html";i:1513303782;s:43:"template/shop\default\controlCommonNav.html";i:1513303782;s:46:"template/shop\default\controlRightSidebar.html";i:1513303782;s:47:"template/shop\default\Goods\controlGallery.html";i:1513303782;s:46:"template/shop\blue\Goods\controlStoreInfo.html";i:1513303781;s:49:"template/shop\default\Goods\controlStoreRank.html";i:1513303782;s:52:"template/shop\default\Goods\controlGoodEvaluate.html";i:1513303782;s:48:"template/shop\default\controlCommonPageAjax.html";i:1513303782;s:58:"template/shop\default\Goods\controlPurchaseConsulting.html";i:1513303782;s:47:"template/shop\default\controlLoveOrHistory.html";i:1513303782;s:53:"template/shop\default\Goods\controlGoodsInfoData.html";i:1513303782;s:48:"template/shop\default\controlBottomLinkHelp.html";i:1513303782;s:40:"template/shop\default\controlBottom.html";i:1513303782;s:39:"template/shop\default\controlLogin.html";i:1513303782;s:40:"template/shop\default\baidu_js_push.html";i:1513303782;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
.realy-price .second-color{font-size: 22px;color: #e23435;}
...
.shop-prom .shop-prom-title dd .i-activity-flag{padding: 0 3px;border: 1px solid #ff0000;color: #ff0000;border-radius: 2px;font-size: 12px;line-height: 14px;margin-right: 5px;white-space: nowrap;}
		...
		<div class="detail-info" style="width:530px;">
			<form action="" method="post" name="formBuyNow" id="formBuyNow">
				...
				<div class="goods-price">
					...
					<?php endif; if($goods_info['mansong_name'] != '' || $goods_info['baoyou_name'] != ''): ?>
					<div class="shop-prom">
...
<!-- 						</div> -->
		...
		<!-- 							<span class="title"><?php echo lang('discount'); ?></span>	 -->
				...
				<div class="freight">
					<div class="dt">服务</div>
					<div class="dd">
						由&nbsp;&nbsp;<a href="javascript:;" style="color:#ff0000;"><?php echo $goods_info['shop_name']; ?></a>&nbsp;&nbsp;发货并提供售后服务
					</div>
				</div>
				<!-- 评价、销量、积分 -->
				<div class="info-other">
					<ul class="other">
						<li><p><?php echo lang('cumulative_evaluation'); ?><span><a id="evaluate_num" href="#" class="second-color"><?php echo $evaluates_count['evaluate_count']; ?></a></span></p></li>
						<li><p><?php echo lang('goods_cumulative_sales'); ?><span class="second-color"><?php echo $goods_info['sales']; ?></span></p></li>
<!-- 						<li class="last"><p><?php echo lang('goods_gift_points'); ?><span class="second-color"><?php echo $goods_info['give_point']; ?></span></p></li> -->
					</ul>
				</div>
				...
				<?php if(is_array($goods_rank) || $goods_rank instanceof \think\Collection || $goods_rank instanceof \think\Paginator): if( count($goods_rank)==0 ) : echo "" ;else: foreach($goods_rank as $k=>$goods): if(($k+1) <= 5): ?>
					<li class="goods-item first">
						...
						<div class="price">
							...
							<span class="color">￥<?php echo $goods['promotion_price']; ?></span>
						</div>
					</li>
					<?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</ul>
		...
		<div class="right right-con">
			<div class="wrapper">
				<div id="main-nav-holder" class="goods-detail">
					<ul id="nav" class="tab">
						<li class="title-list current" data-index="2"><a href="javascript:;" id="goods_detail"><?php echo lang('goods_commodity_details'); ?></a></li>
					 	<li class="title-list" data-index="1"><a href="javascript:;" id="goods_attribute"><?php echo lang('goods_commodity_attribute'); ?></a></li>
						<li class="title-list" data-index="3"><a id="evaluate_count" href="javascript:;"><?php echo lang('goods_cumulative_evaluation'); ?>(<?php echo $evaluates_count['evaluate_count']; ?>)</a></li>
						<li class="title-list" data-index="4"><a href="javascript:;" id="goods_consultation"><?php echo lang('goods_purchase_consultation'); ?></a></li>
					</ul>
...
<!-- 						</div> -->
				...
				<div id="main_widget">
					...
					<div id="goods_attr_list" class="goods-detail-con goods-detail-tabs" style="display:none;">
						<?php if(count($goods_info['goods_attribute_list']) > 0  || $brand_detial != ''): ?>
							<table cellspacing="0">
					...
					<div id="goods_introduce" class="goods-detail-con goods-detail-tabs">
						...
						<?php echo $goods_info['description']; ?>
						</div>
					</div>
					<!-- 商品详情 end -->
					<!-- 商品评价 start -->
			...
			<ul id="history_list" class="history-panel none">
				...
				<?php else: if(is_array($member_histrorys) || $member_histrorys instanceof \think\Collection || $member_histrorys instanceof \think\Paginator): $i = 0; $__LIST__ = $member_histrorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<li>
						...
						<div class="p-comm">
							<span class="p-price color">￥<?php echo $vo['price']; ?></span>
	...
	if($("#hidden_uid").val()==''){
		...
		if(data_max_fetch != 0 && data_receive_quantity>= data_max_fetch){
			layer.open({
				...
				content: '<div class="tip-info"><div class="left"><i class="receiveTip"></i></div><div class="right"><p class="coupon_desc"><?php echo lang('reached_the_limit'); ?>！</p><p class="my_coupon"><?php echo lang('view_the_collar_coupons'); ?>：<a href="<?php echo __URL('SHOP_MAIN/member/vouchers'); ?>" target="_blank"><?php echo lang('my_discount_information'); ?></a></p></div></div>'
			});
			return false;
		}
		$.ajax({
			url : "<?php echo __URL('SHOP_MAIN/goods/receiveGoodsCoupon'); ?>",
			type : "post",
			...
			success : function(res){
				if(res['code']>0){
					...
					layer.open({
						...
						area: ['420px', '200px'], //宽高
						title : "<?php echo lang('receive_coupons'); ?>",
						content: '<div class="tip-info"><div class="left"><i></i></div><div class="right"><p class="coupon_desc"><?php echo lang('congratulations_on_your_success'); ?><span style="color:#FF0000;"><?php echo lang('member_full'); ?>'+data_at_least+'<?php echo lang('element'); ?><?php echo lang('member_reduce'); ?>'+data_money+'<?php echo lang('element'); ?></span><?php echo lang('coupon'); ?></p><p class="use_time"><?php echo lang('use_time'); ?>：'+data_start_time+'-'+data_end_time+'</p><p class="my_coupon"><?php echo lang('view_the_collar_coupons'); ?>：<a href="<?php echo __URL('SHOP_MAIN/member/vouchers'); ?>"  target="_blank"><?php echo lang('my_discount_information'); ?></a></p></div></div>'
					});
					...
					layer.open({
						...
						area: ['420px', '200px'], //宽高
						title : "<?php echo lang('receive_coupons'); ?>",
						content: '<div class="tip-info"><div class="left"><i class="receiveTip"></i></div><div class="right"><p class="coupon_desc"><?php echo lang('has_brought_over'); ?></p><p class="my_coupon"><?php echo lang('view_the_collar_coupons'); ?>：<a href="<?php echo __URL('SHOP_MAIN/member/vouchers'); ?>" target="_blank"><?php echo lang('my_discount_information'); ?></a></p></div></div>'
					});
				}else{
