...
function addAttributeService() {
		location.href = "<?php echo __URL('PLATFORM_MAIN/goods/addattributeservice'); ?>";
	}
$(function(){
	LoadingInfo(1);
});
			...
			buttons: {
				"确定": function() {
					...
					$.ajax({
						...
						success : function(data) {
							if (data['code'] > 0) {
	 							showMessage('success', data["message"],"<?php echo __URL('PLATFORM_MAIN/goods/attributelist'); ?>");
