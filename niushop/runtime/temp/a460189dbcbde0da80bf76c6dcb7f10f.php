...
// 		alert();
  ...
  <div class="user-right"> 
	<div class="box">
		<div class="tabmenu">
			<ul class="tab">
				<li class="first active"><a>我的店铺收藏</a><span style="font-size:12px;margin-left:15px">(收藏以下的店铺后，您绑定的邮箱可随时接受到收藏店铺的最新动态)</span></li>
			</ul>
		</div>
		<div class="mar_top">
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_15079__=1;$__FOR_END_15079__=$page_count+1;for($i=$__FOR_START_15079__;$i < $__FOR_END_15079__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_28838__=1;$__FOR_END_28838__=$page_num+1;for($i=$__FOR_START_28838__;$i < $__FOR_END_28838__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_31233__=$page_count-$page_num+1;$__FOR_END_31233__=$page_count+1;for($i=$__FOR_START_31233__;$i < $__FOR_END_31233__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_13288__=$page-($page_num-1)/2;$__FOR_END_13288__=$page+($page_num-1)/2+1;for($i=$__FOR_START_13288__;$i < $__FOR_END_13288__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
