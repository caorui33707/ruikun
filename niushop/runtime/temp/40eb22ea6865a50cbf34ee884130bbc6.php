...
<!-- 			<div class="title-bar"> -->
<!-- 				<h3 class="help-tit" style="text-align: left;"><?php echo $name; ?></h3> -->
<!-- 			</div> -->
			<?php if(count($result) != 0): if(is_array($result) || $result instanceof \think\Collection || $result instanceof \think\Paginator): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?>
			<div style="margin-top: 15px;">
				<div style="margin-top: 15px; overflow: hidden;">
					<a href="<?php echo __URL('SHOP_MAIN/cms/articleclassinfo', 'article_id='.$news['article_id']); ?>" style="float: left;"><?php echo $news['title']; ?></a>
					<span style="float: right;"><?php echo getTimeStampTurnTime($news['create_time'] ); ?></span>
				</div>
			</div>
			<?php endforeach; endif; else: echo "" ;endif; else: ?>
			<div style="margin-top: 15px;">
				<div style="margin-top: 15px; overflow: hidden;">
					<span><?php echo lang('no_article'); ?></span>
				</div>
			</div>
			<?php endif; ?>
		</div>
