...
<script>	
	...
	*/
	function addModuleAjax() {
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('PLATFORM_MAIN/System/addModule'); ?>",
			data : {
				'pid' : pid,
			...
			success : function(data) {
				if (data["code"] > 0) {
					showMessage('success', "添加成功", "<?php echo __URL('PLATFORM_MAIN/System/moduleList'); ?>");
				}else{
