...
<div class="w1210">
	<div class="breadcrumb clearfix">
		<a href="<?php echo __URL('SHOP_MAIN'); ?>" class="index"><?php echo lang('home_page'); ?>&nbsp;&gt;&nbsp;</a> <span
			class="last"><?php echo $goods_info['category_name']; ?><?php echo $goods_info['goods_name']; ?></span>
	</div>
	<div class="wrapper">
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_18820__=1;$__FOR_END_18820__=$page_count+1;for($i=$__FOR_START_18820__;$i < $__FOR_END_18820__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_21399__=1;$__FOR_END_21399__=$page_num+1;for($i=$__FOR_START_21399__;$i < $__FOR_END_21399__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_15894__=$page_count-$page_num+1;$__FOR_END_15894__=$page_count+1;for($i=$__FOR_START_15894__;$i < $__FOR_END_15894__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_22321__=$page-($page_num-1)/2;$__FOR_END_22321__=$page+($page_num-1)/2+1;for($i=$__FOR_START_22321__;$i < $__FOR_END_22321__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
						...
						<dl>
							...
							<dd>
								...
								<div class="code">
									...
									<a href="JavaScript:void(0);" id="consultCaptchaHide" class="close" title="<?php echo lang('goods_add_cart'); ?>"><i></i></a>
									<!-- <a href="JavaScript:void(0);" nc_type="consultCaptchaChange" class="change" title="<?php echo lang('click_for_another_one'); ?>。"><i></i></a> -->
								</div>
								<a href="JavaScript:void(0);" id="consultSubmit" title="<?php echo lang('publication_consultation'); ?>"
									class="btn btn-sm btn-warning m-l-10"><?php echo lang('publication_consultation'); ?></a>
								<div nc_type="error_msg"></div>
