...
<div class="user-right">
	<div class="box">
		<div class="tabmenu">
			<ul class="tab">
				<li class="active"><a href="#"><?php echo lang('commodity_evaluation_drying_list'); ?></a></li>
			</ul>
		</div>
		<div class="blank"></div>
		<table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#eeeeee" class="item_list">
			<tr>
				<th width="10%"></th>
				<th width="20%"><?php echo lang('goods_commodity_information'); ?></th>
				<th width="50%"><?php echo lang('member_evaluate'); ?></th>
				<th width="20%"><?php echo lang('member_the_sun'); ?></th>
			</tr>
				...
				<tr>
					...
					<td width="400">
						<div>
							...
							<?php $__FOR_START_6411__=0;$__FOR_END_6411__=5;for($i=$__FOR_START_6411__;$i < $__FOR_END_6411__;$i+=1){ if($item['scores'] > $i): ?>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_8410__=1;$__FOR_END_8410__=$page_count+1;for($i=$__FOR_START_8410__;$i < $__FOR_END_8410__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_14981__=1;$__FOR_END_14981__=$page_num+1;for($i=$__FOR_START_14981__;$i < $__FOR_END_14981__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_21500__=$page_count-$page_num+1;$__FOR_END_21500__=$page_count+1;for($i=$__FOR_START_21500__;$i < $__FOR_END_21500__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_7407__=$page-($page_num-1)/2;$__FOR_END_7407__=$page+($page_num-1)/2+1;for($i=$__FOR_START_7407__;$i < $__FOR_END_7407__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
