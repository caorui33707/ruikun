...
<section class="panel panel-default">
	<header class="panel-heading font-bold"> 修改代理商 > <?php if($data['agent_type'] == 1): ?> 个人 <?php else: ?> 公司 <?php endif; ?></header>
	<div class="panel-body">
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<?php echo $data['business_licence_number']; ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<?php echo $data['organization_code']; ?>
				</div>
			</div>
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			<input name="agent_money" value="<?php echo $data['agent_money']; ?>" id="agent_money"/>
		</div>
	</div>
		<?php if($data['is_status'] != 3): ?>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
...
//  		verify(ad_image, link_url);
		...
		$.ajax({
			...
			success : function(data) {
				if (data["code"] > 0) {
					showMessage('success', "操作成功","<?php echo __URL('PLATFORM_MAIN/config/shopAgantList'); ?>");
				}else{
