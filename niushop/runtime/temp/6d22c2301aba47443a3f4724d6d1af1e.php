...
<!-- 添加css、字体文件文件 -->
<script type="text/javascript">
var shopmain = '<?php echo __URL('SHOP_MAIN'); ?>';
</script>
...
<div class="user-right">
    	<div class="box">
          <div class="tabmenu">
            <ul class="tab">
              <li class="active"> <a href="javascript:void(0);" ><?php echo lang('member_my_order'); ?></a> </li>
            </ul>
          </div>
          ...
          <div class="extra-r" style="display:none">
            <div class="search-01">
              <input id="ip_keyword" name="" class="s-itxt" value="<?php echo lang('name_of_commodity_commodity_number_order_no'); ?>" onfocus="if (this.value==this.defaultValue) this.value=&#39;&#39;" onblur="if (this.value==&#39;&#39;) this.value=this.defaultValue" onkeydown="javascript:if(event.keyCode==13) OrderSearch(&#39;ip_keyword&#39;);" type="text">
              <!--input name="" type="button" value="查 询" class="btn-13" onclick="OrderSearch('ip_keyword')" clstag="click|keycount|orderinfo|search"/--> 
              <a href="javascript:;" class="btn-13" onclick="OrderSearch(&#39;ip_keyword&#39;)" clstag="click|keycount|orderinfo|search"><?php echo lang('member_query'); ?></a> </div>
            <div class="blank"></div>
          </div>
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bought-table">
			...
			<tr class="order-hd">
			<td colspan="8">
			<span class="main-color"><span><?php echo $order['shop_name']; ?>&nbsp;&nbsp;</span></span>
			...
			<a class="pic" href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$order_item['goods_id']); ?>" title="<?php echo lang('member_view_baby_details'); ?>" target="_blank">
				<img src="<?php echo __IMG($order_item['picture']['pic_cover_micro']); ?>" alt="" width="50" height="50">
			</a>
			<a href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$order_item['goods_id']); ?>" title="<?php echo lang('member_view_baby_details'); ?>" target="_blank">
		...
		<!-- 	<a href="javascript:;" style="line-height:50px;">留言/投诉</a> -->
			<?php if($order['payment_type'] == 4): if($order['is_refund'] == 1 AND $order_item['refund_status'] == 0 AND $order['order_status'] == 2): ?>
					<div><a href="<?php echo __URL('SHOP_MAIN/member/refunddetail','order_goods_id='.$order_item['order_goods_id']); ?>" style="border: 1px solid #E31939;padding: 3px 8px;color: #E31939;line-height: 45px;"><?php echo lang('list_of_refund_return'); ?></a></div>
				<?php elseif($order_item['refund_status'] != 0): ?>
					...
					<div><a href="javascript:;" class="cancle" style="border: 1px solid #E31939;padding: 3px 8px;color: #E31939;line-height: 45px;" onclick="if(confirm('<?php echo lang("member_sure_cancel"); ?>'))cancleDetail(<?php echo $order['order_id']; ?>,<?php echo $order_item['order_goods_id']; ?>)"><?php echo lang('member_cancellation_refund'); ?></a></div>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_21624__=1;$__FOR_END_21624__=$page_count+1;for($i=$__FOR_START_21624__;$i < $__FOR_END_21624__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_8667__=1;$__FOR_END_8667__=$page_num+1;for($i=$__FOR_START_8667__;$i < $__FOR_END_8667__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_2794__=$page_count-$page_num+1;$__FOR_END_2794__=$page_count+1;for($i=$__FOR_START_2794__;$i < $__FOR_END_2794__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_17109__=$page-($page_num-1)/2;$__FOR_END_17109__=$page+($page_num-1)/2+1;for($i=$__FOR_START_17109__;$i < $__FOR_END_17109__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
