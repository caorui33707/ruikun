<?php if (!defined('THINK_PATH')) exit(); /*a:19:{s:42:"template/shop\default\Goods\goodsList.html";i:1513303782;s:31:"template/shop\default\base.html";i:1513303782;s:35:"template/shop\default\urlModel.html";i:1513303782;s:37:"template/shop\default\controlTop.html";i:1513303782;s:44:"template/shop\default\controlHeadSerach.html";i:1513303782;s:47:"template/shop\default\controlHeadSearchAdv.html";i:1513303782;s:46:"template/shop\default\controlHeadGoodType.html";i:1513303782;s:43:"template/shop\default\controlCommonNav.html";i:1513303782;s:46:"template/shop\default\controlRightSidebar.html";i:1513303782;s:63:"template/shop\default\Goods\controlGoodsCategoryConditions.html";i:1513303782;s:49:"template/shop\default\Goods\controlGoodsLeft.html";i:1513303782;s:48:"template/shop\default\Goods\controlGoodList.html";i:1513303782;s:62:"template/shop\default\Goods\controlPopUpGoodsSkuAttribute.html";i:1513303782;s:44:"template/shop\default\controlCommonPage.html";i:1513303782;s:47:"template/shop\default\controlLoveOrHistory.html";i:1513303782;s:48:"template/shop\default\controlBottomLinkHelp.html";i:1513303782;s:40:"template/shop\default\controlBottom.html";i:1513303782;s:39:"template/shop\default\controlLogin.html";i:1513303782;s:40:"template/shop\default\baidu_js_push.html";i:1513303782;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- 					<div class="sell-out"></div> -->
					...
					<div class="p-price">
						<span class="sale-price color">￥<?php echo $goodsinfo['promotion_price']; ?></span>
	...
	<div id="filter">
		...
		<form method="get" name="listform" action="" style="position: relative;">
			<div class="fore1">
				...
				<div class="total">共 <span class="color" id="shops_count"><?php echo $total_count; ?></span><?php echo lang('goods_goods'); ?>&nbsp;</div>
					...
					<dl class="location-all">
						...
						<dd>
							...
							<ul>
								...
								<li>
									<p class="lt">Q</p>
									<p class="lc"> <span><a href="<?php echo __URL('SHOP_MAIN/goods/goodslist',$url_parameter_not_province_id.'&province_id=29&province_name=青海'.$attr_url); ?>">青海</a></span> </p>
								</li>
								<li>
									<p class="lt">S</p>
									<p class="lc"> 
							...
							<ul>
								<li>
									<p class="lt">T</p>
									<p class="lc"> <span><a href="<?php echo __URL('SHOP_MAIN/goods/goodslist',$url_parameter_not_province_id.'&province_id=34&province_name=台湾'.$attr_url); ?>">台湾</a></span> </p>
								</li>
								<li>
									<p class="lt">X</p>
									<p class="lc"> 
										...
										<span><a href="<?php echo __URL('SHOP_MAIN/goods/goodslist',$url_parameter_not_province_id.'&province_id=31&province_name=新疆'.$attr_url); ?>">新疆</a></span> <span><a href="">香港</a></span> 
									</p>
								</li>
								<li>
									<p class="lt">Y</p>
									<p class="lc"> <span><a href="<?php echo __URL('SHOP_MAIN/goods/goodslist',$url_parameter_not_province_id.'&province_id=25&province_name=云南'.$attr_url); ?>">云南</a></span> </p>
								</li>
								<li>
									<p class="lt">Z</p>
									<p class="lc"> <span><a href="<?php echo __URL('SHOP_MAIN/goods/goodslist',$url_parameter_not_province_id.'&province_id=11&province_name=浙江'.$attr_url); ?>">浙江</a></span> </p>
								</li>
							</ul>
						</dd>
					</dl>
		...
		<ul class="list-grid clearfix js-list-grid">
			...
			<li class="item <?php if($k != 0 && ($k+1)%4==0): ?>last<?php endif; ?>">
				<div class="item-con">
					...
					<div class="item-info">
						<div class="item-price"><em class="sale-price color">￥<?php echo $goods['promotion_price']; ?></em></div>
						<div class="item-name"><a href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$goods['goods_id']); ?>" target="_blank" title="<?php echo $goods['goods_name']; ?>"><?php echo $goods['goods_name']; ?></a>
						<br/><a href="<?php echo __URL('SHOP_MAIN/shop/shopindex?shop_id='.$goods['shop_id']); ?>" target="_blank" title="<?php echo $goods['shop_name']; ?>"><?php echo $goods['shop_name']; ?></a>
						</div>
						<div class="item-con-info">
							...
							<div class="fl">
								<div class="item-operate <?php if($goods['is_favorite']>0): ?>is_favorite<?php endif; ?>">
										...
										<i data-log-id="<?php echo $goods['is_favorite']; ?>"></i>
...
<div id="speDiv" style="display: none;">
	<div class="pop-header">
		<span><?php echo lang('goods_select_commodity_attribute'); ?></span> <a href="javascript:closeBuy()" title="<?php echo lang('goods_add_cart'); ?>" class="spe-close"></a>
	</div>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_16652__=1;$__FOR_END_16652__=$page_count+1;for($i=$__FOR_START_16652__;$i < $__FOR_END_16652__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_21567__=1;$__FOR_END_21567__=$page_num+1;for($i=$__FOR_START_21567__;$i < $__FOR_END_21567__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_14430__=$page_count-$page_num+1;$__FOR_END_14430__=$page_count+1;for($i=$__FOR_START_14430__;$i < $__FOR_END_14430__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_11673__=$page-($page_num-1)/2;$__FOR_END_11673__=$page+($page_num-1)/2+1;for($i=$__FOR_START_11673__;$i < $__FOR_END_11673__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info,'page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
