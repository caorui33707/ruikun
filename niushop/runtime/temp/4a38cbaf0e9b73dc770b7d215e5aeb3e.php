	...
	<table class="table table-striped b-t b-light text-sm">
		...
		<tbody>
			...
			<tr class="pid_0" style="height: 30px;">
				...
				<td class="center"><a
					href="<?php echo __URL('PLATFORM_MAIN/System/editModule?module_id='.$v1['module_id']); ?>"
			...
			<tr class="pid_<?php echo $v1['module_id']; ?>" style="display: none;">
				...
				<td class="center"><a href="#"
					...
					onclick="changeField(<?php echo $v2['module_id']; ?>, 'is_menu', <?php echo !empty($v2['is_menu'])?0 : 1; ?>);"><i
						...
						class="fa fa-times text-danger text"></i></a></td>
				<td class="center"><a
					href="<?php echo __URL('PLATFORM_MAIN/System/editModule?module_id='.$v2['module_id']); ?>"
					title="修改">修改</a> <a href="javascript:void(0);"
			...
			<tr class="pid_<?php echo $v2['module_id']; ?> pid_<?php echo $v1['module_id']; ?>"
				...
				<td class="center"><a href="#"
					...
					onclick="changeField(<?php echo $v3['module_id']; ?>, 'is_menu', <?php echo !empty($v3['is_menu'])?0 : 1; ?>);"><i
						...
						class="fa fa-times text-danger text"></i></a></td>
				<td class="center"><a
					href="<?php echo __URL('PLATFORM_MAIN/System/editModule?module_id='.$v3['module_id']); ?>"
					title="修改">修改</a> <a href="javascript:void(0);"
			...
			<tr
				...
				<td class="center"><a href="#"
					...
					onclick="changeField(<?php echo $v4['module_id']; ?>, 'is_menu', <?php echo !empty($v4['is_menu'])?0 : 1; ?>);"><i
						...
						class="fa fa-times text-danger text"></i></a></td>
				<td class="center"><a
					href= "<?php echo __URL('PLATFORM_MAIN/System/editModule?module_id='.$v4['module_id']); ?>"
					title="修改">修改</a> <a href="javascript:void(0);"
			...
			<tr
				...
				<td class="center"><a href="#"
					...
					onclick="changeField(<?php echo $v5['module_id']; ?>, 'is_menu', <?php echo !empty($v5['is_menu'])?0 : 1; ?>);"><i
						...
						class="fa fa-times text-danger text"></i></a></td>
				<td class="center"><a
					href="<?php echo __URL('PLATFORM_MAIN/System/editModule?module_id='.$v5['module_id']); ?>"
					title="修改">修改</a> <a href="javascript:void(0);"
	            ...
	            buttons: {
	                "确定,#e57373": function() {
	                    ...
	                    $.ajax({
	        				...
	        				success:function (data) {
	        					if(data['code'] > 0){
	        						location.href = "<?php echo __URL('PLATFORM_MAIN/system/modulelist'); ?>";
	        					}else{
	        						$("#dialog").dialog({
	        							 buttons: {
	        					                "确定,#e57373": function() {
