...
class Login extends Controller
{
    ...
    public function init()
    {
        ...
        $noticeMobile2= $config->getRecommendMobile($instance_id);
        $this->notice['noticeEmail'] = $noticeEmail[0]['is_use'];
        $this->notice['noticeMobile'] = $noticeMobile[0]['is_use'];
        $this->notice['recommendMobile'] = $noticeMobile2['is_use'];
    ...
    public function mobile(){
        ...
        if (request()->isPost()) {
            ...
            if ($retval > 0 && $result) {
               ...
               // $invite_code = runhook('Notify','createCode',$retval);
