...
$(function(){
	...
	<div class="member-main">
		<div class="box">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="first active"><?php echo lang('member_balance_withdrawal'); ?></li>
				</ul>
			</div>
			<div data-alert class="alert-box alert" id="errerMsg" style="display: none;"><a href="#" class="close">&times;</a></div>
				<div class="extract">
					<div class="commision-total">
						<div style="float:left;width:10%;text-align:right;padding:5px 10px;font-size: 14px;"><?php echo lang('member_cash_available'); ?>：</div>
						<div style="width: 80%;float:left;font-size:18px;color:#0689e1;padding:5px 0;" id="Amount">¥<?php echo $account; ?></div>
					</div>
				</div>
				<div class="extract">
					<div class="commision-total" style="width:10%;text-align:right;float:left;padding:5px 10px;font-size: 14px;"><?php echo lang('member_cash_account'); ?>：</div>
					<div style="width: 80%;float:left;">
						...
						<div class="commision-right">
							<div style="width:20%;float:right;text-align: center;margin-top: -8px;margin-right: -8px;">
								<a href="javascript:;" onclick="updatebankinfo(<?php echo $vo['id']; ?>,<?php echo $shop_id; ?>);" title="<?php echo lang('edit'); ?>"><img src="__TEMP__/<?php echo $style; ?>/public/images/edit-cash.png" style="margin-right: 10px;" /></a>
				...
				<div class="extract">
					<div class="commision-total" style="width:10%;text-align:right;float:left;padding:5px 10px;font-size: 14px;"><?php echo lang('member_cash_withdrawal'); ?>：</div>
				...
				<div class="common-btn" onclick="btnSave()" style="margin:10px 120px;"><?php echo lang('member_apply_immediately'); ?></div>
...
$(function(){
	...
	$(".js-bread-crumb").attr("href",'<?php echo __URL('SHOP_MAIN/member/balancewithdrawlist'); ?>');
	$(".js-bread-crumb").text("<?php echo lang('member_cash_register'); ?>");
	$(".js-bread-crumb").parent().append('<span class="crumbs-arrow">&gt;</span><a href="<?php echo __URL('SHOP_MAIN/member/balancewithdrawals'); ?>"><?php echo lang('member_balance_withdrawal'); ?></a>');
});
