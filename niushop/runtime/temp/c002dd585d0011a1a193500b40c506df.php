		...
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					...
					<p class="hint" style="color:#BBB;margin-top:10px;">快递鸟</p>
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					...
					<p class="hint" style="color:#BBB;margin-top:10px;">应用密钥</p>
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<p><a href="http://www.kdniao.com/" target="_brank">点击申请</a></p>
					<p class="hint" style="color:#BBB;margin-top:10px;">点击进行申请</p>
				</div>
			</div>
			<div class="form-group">
...
<script>
	...
	function setExpressConfigAjax(){
		...
		$.ajax({
			type:"post",
			url : "<?php echo __URL('PLATFORM_MAIN/config/expressmessage'); ?>",
			data : {
				"appid" : appid,
				"appkey":appkey,
				"back_url" : back_url,
			...
			success : function(data){
				if(data['code'] > 0){
					showMessage('success', data["message"],"<?php echo __URL('PLATFORM_MAIN/config/expressmessage'); ?>");
				}else{
