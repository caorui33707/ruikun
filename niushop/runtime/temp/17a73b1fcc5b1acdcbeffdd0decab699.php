<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\Config\shopAdList.html";i:1513303780;s:28:"template/adminblue\base.html";i:1513303780;s:45:"template/adminblue\controlCommonVariable.html";i:1513303780;s:32:"template/adminblue\urlModel.html";i:1513303781;s:34:"template/adminblue\pageCommon.html";i:1513303781;s:34:"template/adminblue\openDialog.html";i:1513303780;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/config/addshopad'); ?>';">添加广告</button>
</div>
...
function LoadingInfo(page_index) {
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/shopadlist'); ?>",
		data : {
...
function delShopAd(id){
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/delshopad'); ?>",
		data : { 'id' : id },
		success : function(data) {
			if (data["code"] > 0) {
				showMessage('success', "店铺广告删除成功","<?php echo __URL('ADMIN_MAIN/config/shopadlist'); ?>");
			}else{
